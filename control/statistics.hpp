    ...
    class Statistics
    {
      public:
          ...
          DomainType_ & domain)
        {
          ...
          {
            std::cout<< "\n";
            std::cout << String("TOE partition:").pad_back(20) << FEAT::Statistics::toe_partition << "\n";
            std::cout << String("TOE assembly:").pad_back(20) << FEAT::Statistics::toe_assembly << "\n";
            std::cout << String("TOE solve:").pad_back(20) << FEAT::Statistics::toe_solve << "\n";
            ...
            std::cout<<String("#DOFs:").pad_back(20) << "coarse " << dofs_coarse_max << "/" << dofs_coarse_min << ", fine " << dofs_fine_max << "/" << dofs_fine_min << "\n";
            std::cout<<String("#NZEs").pad_back(20) << "coarse " << nzes_coarse_max << "/" << nzes_coarse_min << ", fine " << nzes_fine_max << "/" << nzes_fine_min << "\n";
            std::cout<<"\n";
          }
