  ...
  namespace Control
  {
    ...
    class CheckpointControl
    {
      private:
        ...
        std::map<String, Checkpointable*> _checkpointable_by_identifier;
      ...
      public:
         ...
         *
         */
        void add_object(String identifier, Checkpointable* object)
        {
          ...
          _checkpointable_by_identifier[identifier] = object;
        }
         ...
         */
        void restore_object(String identifier, Checkpointable & object, bool add_to_checkpoint_control = true)
        {
          ...
          object.restore_from_checkpoint_data(buffer);
