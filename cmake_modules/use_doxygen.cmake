...
#                       PATHS "${CMAKE_CURRENT_SOURCE_DIR}" "${FEAST_SOURCE_DIR}/cmake_modules/"
#                       NO_DEFAULT_PATH)
...
if(DOXYGEN_FOUND )#AND DOXYFILE_IN_FOUND)
  #add_custom_target(doxygen ${DOXYGEN_EXECUTABLE} ${CMAKE_CURRENT_BINARY_DIR}/doc/Doxyfile)
  add_custom_target(doxygen ${DOXYGEN_EXECUTABLE} ${CMAKE_CURRENT_BINARY_DIR}/doc/doxygen_config)
