...
if (CMAKE_SYSTEM_NAME STREQUAL "Linux")
  ...
  set (OPEN64_VERSION_MAJOR "")
  set (OPEN64_VERSION_MINOR "")
  set (OPEN64_VERSION_MINORMINOR "")
  ...
  string(REGEX REPLACE ".*([0-9]+)[.][0-9]+[.]+[0-9].*" "\\1" OPEN64_VERSION_MAJOR "${OPEN64_VERSION_STRING}")
  string(REGEX REPLACE ".*[0-9]+[.]([0-9]+)[.]+[0-9].*" "\\1" OPEN64_VERSION_MINOR "${OPEN64_VERSION_STRING}")
  string(REGEX REPLACE ".*[0-9]+[.][0-9]+[.]([0-9]+).*" "\\1" OPEN64_VERSION_MINORMINOR "${OPEN64_VERSION_STRING}")
  message (STATUS "Found GNU compiler suite v.${OPEN64_VERSION_MAJOR}.${OPEN64_VERSION_MINOR}.${OPEN64_VERSION_MINORMINOR}.")
  # and check for recent enough version
  if ("${OPEN64_VERSION_MAJOR}.${OPEN64_VERSION_MINOR}.${OPEN64_VERSION_MINORMINOR}" VERSION_LESS "4.2.3")
    message (STATUS "##############################################################")
    message (STATUS "OPEN64 Compiler Version ${OPEN64_VERSION_MAJOR}.${OPEN64_VERSION_MINOR}.${OPEN64_VERSION_MINORMINOR} is not supported,")
...
if (NOT COMPILER_SUPPORTS_FLAG)
  ...
  message (STATUS "unsupported by the OPEN64 Compiler v.${OPEN64_VERSION_MAJOR}.${OPEN64_VERSION_MINOR}.${OPEN64_VERSION_MINORMINOR}.")
  message (STATUS "##############################################################")
  message (FATAL_ERROR "")
endif ()
