...
int main(int argc, char* argv[])
{
  ...
  typedef Space::Lagrange1::Element<TrafoType> SpaceType1;
  ...
  typedef LAFEM::DenseVectorBlocked<DataType, IndexType, 2> LocalVectorType1;
  //typedef LAFEM::DenseVector<DataType, IndexType> LocalVectorType1;
  typedef LAFEM::DenseVector<DataType, IndexType> LocalVectorType2;
  typedef LAFEM::TupleVector<LocalVectorType1, LocalVectorType2> LocalVectorType;

  //typedef LAFEM::DenseVector<DataType, IndexType> BufferVectorType;

  typedef LAFEM::VectorMirror<DataType, IndexType> VectorMirrorType1;
  typedef LAFEM::VectorMirror<DataType, IndexType> VectorMirrorType2;
  typedef LAFEM::TupleMirror<VectorMirrorType1, VectorMirrorType2> VectorMirrorType;

  typedef Global::Gate<LocalVectorType, VectorMirrorType> GateType;


  typedef LAFEM::SparseMatrixBCSR<DataType, IndexType, 2, 2> LocalMatrixType11;
  typedef LAFEM::SparseMatrixBCSR<DataType, IndexType, 2, 1> LocalMatrixType12;
  typedef LAFEM::SparseMatrixBCSR<DataType, IndexType, 1, 2> LocalMatrixType21;
  ...
  typedef LAFEM::UnitFilterBlocked<DataType, IndexType, 2> LocalFilterType1;
  //typedef LAFEM::UnitFilter<DataType, IndexType> LocalFilterType1;
  //typedef LAFEM::MeanFilter<DataType, IndexType> LocalFilterType2;
  typedef LAFEM::UnitFilter<DataType, IndexType> LocalFilterType2;

  typedef LAFEM::TupleFilter<LocalFilterType1, LocalFilterType2> LocalFilterType;
  ...
  {
    LocalVectorType tmp;
    tmp.at<0>() = LocalVectorType1(space_1.get_num_dofs());
    tmp.at<1>() = LocalVectorType2(space_2.get_num_dofs());
  ...
  Assembly::SymbolicAssembler::assemble_matrix_std1(matrix.local().at<0,0>(), space_1);
  Assembly::SymbolicAssembler::assemble_matrix_std1(matrix.local().at<1,1>(), space_2);
  ...
  comm.print("Global DOF Offet / Count:");
