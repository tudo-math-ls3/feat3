...
namespace DbgDistUmbrellaSmooth
{
  ...
  void run_reader(Dist::Comm& comm, SimpleArgParser& args, Geometry::MeshFileReader& mesh_reader)
  {
    ...
    // smooth meshes
    Geometry::DistributedUmbrellaSmoother<MeshType> mesh_smoother_1(comm, *mesh_node_1);
    Geometry::DistributedUmbrellaSmoother<MeshType> mesh_smoother_2(comm, *mesh_node_2);

    mesh_smoother_1.smooth(10000, 1e-10, true);
    ...
    exporter_1.write("dbg-dist-umbrella-smooth.1", comm);
    exporter_2.write("dbg-dist-umbrella-smooth.2", comm);
  }
...
int main(int argc, char* argv [])
{
  ...
  try
  {
    DbgDistUmbrellaSmooth::main(argc, argv);
  }
