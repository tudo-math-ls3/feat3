if(NOT TARGET Zoltan::Zoltan)
  ...
  if(WIN32)
    configure_file(${FEAT_SOURCE_DIR}/thirdparty/config_zoltan.h.win.in ${zoltan_SOURCE_DIR}/src/include/Zoltan_config.h @ONLY)
  else()
    configure_file(${FEAT_SOURCE_DIR}/thirdparty/config_zoltan.h.linux.in ${zoltan_SOURCE_DIR}/src/include/Zoltan_config.h @ONLY)
  endif()
