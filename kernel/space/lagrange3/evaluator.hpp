    ...
    namespace Lagrange3
    {
      ...
      public:
        ...
        void NOINLINE eval_ref_hessians(EvalData_& data, const DomainPointType& point) const
        {
          ...
          // all hail to regular expressions!
          ...
          data.phi[0].ref_hess[1][0] = d1p0(point[0]) * d1p0(point[1]) * p0(point[2]);
          data.phi[0].ref_hess[0][2] =
          data.phi[0].ref_hess[2][0] = d1p0(point[0]) * p0(point[1]) * d1p0(point[2]);
          data.phi[0].ref_hess[1][2] =
          data.phi[0].ref_hess[2][1] = p0(point[0]) * d1p0(point[1]) * d1p0(point[2]);
          ...
          data.phi[1].ref_hess[1][0] = d1p1(point[0]) * d1p0(point[1]) * p0(point[2]);
          data.phi[1].ref_hess[0][2] =
          data.phi[1].ref_hess[2][0] = d1p1(point[0]) * p0(point[1]) * d1p0(point[2]);
          data.phi[1].ref_hess[1][2] =
          data.phi[1].ref_hess[2][1] = p1(point[0]) * d1p0(point[1]) * d1p0(point[2]);
          ...
          data.phi[2].ref_hess[1][0] = d1p0(point[0]) * d1p1(point[1]) * p0(point[2]);
          data.phi[2].ref_hess[0][2] =
          data.phi[2].ref_hess[2][0] = d1p0(point[0]) * p1(point[1]) * d1p0(point[2]);
          data.phi[2].ref_hess[1][2] =
          data.phi[2].ref_hess[2][1] = p0(point[0]) * d1p1(point[1]) * d1p0(point[2]);
          ...
          data.phi[3].ref_hess[1][0] = d1p1(point[0]) * d1p1(point[1]) * p0(point[2]);
          data.phi[3].ref_hess[0][2] =
          data.phi[3].ref_hess[2][0] = d1p1(point[0]) * p1(point[1]) * d1p0(point[2]);
          data.phi[3].ref_hess[1][2] =
          data.phi[3].ref_hess[2][1] = p1(point[0]) * d1p1(point[1]) * d1p0(point[2]);
          ...
          data.phi[4].ref_hess[1][0] = d1p0(point[0]) * d1p0(point[1]) * p1(point[2]);
          data.phi[4].ref_hess[0][2] =
          data.phi[4].ref_hess[2][0] = d1p0(point[0]) * p0(point[1]) * d1p1(point[2]);
          data.phi[4].ref_hess[1][2] =
          data.phi[4].ref_hess[2][1] = p0(point[0]) * d1p0(point[1]) * d1p1(point[2]);
          ...
          data.phi[5].ref_hess[1][0] = d1p1(point[0]) * d1p0(point[1]) * p1(point[2]);
          data.phi[5].ref_hess[0][2] =
          data.phi[5].ref_hess[2][0] = d1p1(point[0]) * p0(point[1]) * d1p1(point[2]);
          data.phi[5].ref_hess[1][2] =
          data.phi[5].ref_hess[2][1] = p1(point[0]) * d1p0(point[1]) * d1p1(point[2]);
          ...
          data.phi[6].ref_hess[1][0] = d1p0(point[0]) * d1p1(point[1]) * p1(point[2]);
          data.phi[6].ref_hess[0][2] =
          data.phi[6].ref_hess[2][0] = d1p0(point[0]) * p1(point[1]) * d1p1(point[2]);
          data.phi[6].ref_hess[1][2] =
          data.phi[6].ref_hess[2][1] = p0(point[0]) * d1p1(point[1]) * d1p1(point[2]);
          ...
          data.phi[7].ref_hess[1][0] = d1p1(point[0]) * d1p1(point[1]) * p1(point[2]);
          data.phi[7].ref_hess[0][2] =
          data.phi[7].ref_hess[2][0] = d1p1(point[0]) * p1(point[1]) * d1p1(point[2]);
          data.phi[7].ref_hess[1][2] =
          data.phi[7].ref_hess[2][1] = p1(point[0]) * d1p1(point[1]) * d1p1(point[2]);
          data.phi[ek[ 0][0]].ref_hess[0][0] = d2p2(point[0]) * p0(point[1]) * p0(point[2]);
          data.phi[ek[ 0][0]].ref_hess[1][1] = p2(point[0]) * d2p0(point[1]) * p0(point[2]);
          data.phi[ek[ 0][0]].ref_hess[2][2] = p2(point[0]) * p0(point[1]) * d2p0(point[2]);
          data.phi[ek[ 0][0]].ref_hess[0][1] =
          data.phi[ek[ 0][0]].ref_hess[1][0] = d1p2(point[0]) * d1p0(point[1]) * p0(point[2]);
          data.phi[ek[ 0][0]].ref_hess[0][2] =
          data.phi[ek[ 0][0]].ref_hess[2][0] = d1p2(point[0]) * p0(point[1]) * d1p0(point[2]);
          data.phi[ek[ 0][0]].ref_hess[1][2] =
          data.phi[ek[ 0][0]].ref_hess[2][1] = p2(point[0]) * d1p0(point[1]) * d1p0(point[2]);
          data.phi[ek[ 0][1]].ref_hess[0][0] = d2p3(point[0]) * p0(point[1]) * p0(point[2]);
          data.phi[ek[ 0][1]].ref_hess[1][1] = p3(point[0]) * d2p0(point[1]) * p0(point[2]);
          data.phi[ek[ 0][1]].ref_hess[2][2] = p3(point[0]) * p0(point[1]) * d2p0(point[2]);
          data.phi[ek[ 0][1]].ref_hess[0][1] =
          data.phi[ek[ 0][1]].ref_hess[1][0] = d1p3(point[0]) * d1p0(point[1]) * p0(point[2]);
          data.phi[ek[ 0][1]].ref_hess[0][2] =
          data.phi[ek[ 0][1]].ref_hess[2][0] = d1p3(point[0]) * p0(point[1]) * d1p0(point[2]);
          data.phi[ek[ 0][1]].ref_hess[1][2] =
          data.phi[ek[ 0][1]].ref_hess[2][1] = p3(point[0]) * d1p0(point[1]) * d1p0(point[2]);
          data.phi[ek[ 1][0]].ref_hess[0][0] = d2p2(point[0]) * p1(point[1]) * p0(point[2]);
          data.phi[ek[ 1][0]].ref_hess[1][1] = p2(point[0]) * d2p1(point[1]) * p0(point[2]);
          data.phi[ek[ 1][0]].ref_hess[2][2] = p2(point[0]) * p1(point[1]) * d2p0(point[2]);
          data.phi[ek[ 1][0]].ref_hess[0][1] =
          data.phi[ek[ 1][0]].ref_hess[1][0] = d1p2(point[0]) * d1p1(point[1]) * p0(point[2]);
          data.phi[ek[ 1][0]].ref_hess[0][2] =
          data.phi[ek[ 1][0]].ref_hess[2][0] = d1p2(point[0]) * p1(point[1]) * d1p0(point[2]);
          data.phi[ek[ 1][0]].ref_hess[1][2] =
          data.phi[ek[ 1][0]].ref_hess[2][1] = p2(point[0]) * d1p1(point[1]) * d1p0(point[2]);
          data.phi[ek[ 1][1]].ref_hess[0][0] = d2p3(point[0]) * p1(point[1]) * p0(point[2]);
          data.phi[ek[ 1][1]].ref_hess[1][1] = p3(point[0]) * d2p1(point[1]) * p0(point[2]);
          data.phi[ek[ 1][1]].ref_hess[2][2] = p3(point[0]) * p1(point[1]) * d2p0(point[2]);
          data.phi[ek[ 1][1]].ref_hess[0][1] =
          data.phi[ek[ 1][1]].ref_hess[1][0] = d1p3(point[0]) * d1p1(point[1]) * p0(point[2]);
          data.phi[ek[ 1][1]].ref_hess[0][2] =
          data.phi[ek[ 1][1]].ref_hess[2][0] = d1p3(point[0]) * p1(point[1]) * d1p0(point[2]);
          data.phi[ek[ 1][1]].ref_hess[1][2] =
          data.phi[ek[ 1][1]].ref_hess[2][1] = p3(point[0]) * d1p1(point[1]) * d1p0(point[2]);
          data.phi[ek[ 2][0]].ref_hess[0][0] = d2p2(point[0]) * p0(point[1]) * p1(point[2]);
          data.phi[ek[ 2][0]].ref_hess[1][1] = p2(point[0]) * d2p0(point[1]) * p1(point[2]);
          data.phi[ek[ 2][0]].ref_hess[2][2] = p2(point[0]) * p0(point[1]) * d2p1(point[2]);
          data.phi[ek[ 2][0]].ref_hess[0][1] =
          data.phi[ek[ 2][0]].ref_hess[1][0] = d1p2(point[0]) * d1p0(point[1]) * p1(point[2]);
          data.phi[ek[ 2][0]].ref_hess[0][2] =
          data.phi[ek[ 2][0]].ref_hess[2][0] = d1p2(point[0]) * p0(point[1]) * d1p1(point[2]);
          data.phi[ek[ 2][0]].ref_hess[1][2] =
          data.phi[ek[ 2][0]].ref_hess[2][1] = p2(point[0]) * d1p0(point[1]) * d1p1(point[2]);
          data.phi[ek[ 2][1]].ref_hess[0][0] = d2p3(point[0]) * p0(point[1]) * p1(point[2]);
          data.phi[ek[ 2][1]].ref_hess[1][1] = p3(point[0]) * d2p0(point[1]) * p1(point[2]);
          data.phi[ek[ 2][1]].ref_hess[2][2] = p3(point[0]) * p0(point[1]) * d2p1(point[2]);
          data.phi[ek[ 2][1]].ref_hess[0][1] =
          data.phi[ek[ 2][1]].ref_hess[1][0] = d1p3(point[0]) * d1p0(point[1]) * p1(point[2]);
          data.phi[ek[ 2][1]].ref_hess[0][2] =
          data.phi[ek[ 2][1]].ref_hess[2][0] = d1p3(point[0]) * p0(point[1]) * d1p1(point[2]);
          data.phi[ek[ 2][1]].ref_hess[1][2] =
          data.phi[ek[ 2][1]].ref_hess[2][1] = p3(point[0]) * d1p0(point[1]) * d1p1(point[2]);
          data.phi[ek[ 3][0]].ref_hess[0][0] = d2p2(point[0]) * p1(point[1]) * p1(point[2]);
          data.phi[ek[ 3][0]].ref_hess[1][1] = p2(point[0]) * d2p1(point[1]) * p1(point[2]);
          data.phi[ek[ 3][0]].ref_hess[2][2] = p2(point[0]) * p1(point[1]) * d2p1(point[2]);
          data.phi[ek[ 3][0]].ref_hess[0][1] =
          data.phi[ek[ 3][0]].ref_hess[1][0] = d1p2(point[0]) * d1p1(point[1]) * p1(point[2]);
          data.phi[ek[ 3][0]].ref_hess[0][2] =
          data.phi[ek[ 3][0]].ref_hess[2][0] = d1p2(point[0]) * p1(point[1]) * d1p1(point[2]);
          data.phi[ek[ 3][0]].ref_hess[1][2] =
          data.phi[ek[ 3][0]].ref_hess[2][1] = p2(point[0]) * d1p1(point[1]) * d1p1(point[2]);
          data.phi[ek[ 3][1]].ref_hess[0][0] = d2p3(point[0]) * p1(point[1]) * p1(point[2]);
          data.phi[ek[ 3][1]].ref_hess[1][1] = p3(point[0]) * d2p1(point[1]) * p1(point[2]);
          data.phi[ek[ 3][1]].ref_hess[2][2] = p3(point[0]) * p1(point[1]) * d2p1(point[2]);
          data.phi[ek[ 3][1]].ref_hess[0][1] =
          data.phi[ek[ 3][1]].ref_hess[1][0] = d1p3(point[0]) * d1p1(point[1]) * p1(point[2]);
          data.phi[ek[ 3][1]].ref_hess[0][2] =
          data.phi[ek[ 3][1]].ref_hess[2][0] = d1p3(point[0]) * p1(point[1]) * d1p1(point[2]);
          data.phi[ek[ 3][1]].ref_hess[1][2] =
          data.phi[ek[ 3][1]].ref_hess[2][1] = p3(point[0]) * d1p1(point[1]) * d1p1(point[2]);
          data.phi[ek[ 4][0]].ref_hess[0][0] = d2p0(point[0]) * p2(point[1]) * p0(point[2]);
          data.phi[ek[ 4][0]].ref_hess[1][1] = p0(point[0]) * d2p2(point[1]) * p0(point[2]);
          data.phi[ek[ 4][0]].ref_hess[2][2] = p0(point[0]) * p2(point[1]) * d2p0(point[2]);
          data.phi[ek[ 4][0]].ref_hess[0][1] =
          data.phi[ek[ 4][0]].ref_hess[1][0] = d1p0(point[0]) * d1p2(point[1]) * p0(point[2]);
          data.phi[ek[ 4][0]].ref_hess[0][2] =
          data.phi[ek[ 4][0]].ref_hess[2][0] = d1p0(point[0]) * p2(point[1]) * d1p0(point[2]);
          data.phi[ek[ 4][0]].ref_hess[1][2] =
          data.phi[ek[ 4][0]].ref_hess[2][1] = p0(point[0]) * d1p2(point[1]) * d1p0(point[2]);
          data.phi[ek[ 4][1]].ref_hess[0][0] = d2p0(point[0]) * p3(point[1]) * p0(point[2]);
          data.phi[ek[ 4][1]].ref_hess[1][1] = p0(point[0]) * d2p3(point[1]) * p0(point[2]);
          data.phi[ek[ 4][1]].ref_hess[2][2] = p0(point[0]) * p3(point[1]) * d2p0(point[2]);
          data.phi[ek[ 4][1]].ref_hess[0][1] =
          data.phi[ek[ 4][1]].ref_hess[1][0] = d1p0(point[0]) * d1p3(point[1]) * p0(point[2]);
          data.phi[ek[ 4][1]].ref_hess[0][2] =
          data.phi[ek[ 4][1]].ref_hess[2][0] = d1p0(point[0]) * p3(point[1]) * d1p0(point[2]);
          data.phi[ek[ 4][1]].ref_hess[1][2] =
          data.phi[ek[ 4][1]].ref_hess[2][1] = p0(point[0]) * d1p3(point[1]) * d1p0(point[2]);
          data.phi[ek[ 5][0]].ref_hess[0][0] = d2p1(point[0]) * p2(point[1]) * p0(point[2]);
          data.phi[ek[ 5][0]].ref_hess[1][1] = p1(point[0]) * d2p2(point[1]) * p0(point[2]);
          data.phi[ek[ 5][0]].ref_hess[2][2] = p1(point[0]) * p2(point[1]) * d2p0(point[2]);
          data.phi[ek[ 5][0]].ref_hess[0][1] =
          data.phi[ek[ 5][0]].ref_hess[1][0] = d1p1(point[0]) * d1p2(point[1]) * p0(point[2]);
          data.phi[ek[ 5][0]].ref_hess[0][2] =
          data.phi[ek[ 5][0]].ref_hess[2][0] = d1p1(point[0]) * p2(point[1]) * d1p0(point[2]);
          data.phi[ek[ 5][0]].ref_hess[1][2] =
          data.phi[ek[ 5][0]].ref_hess[2][1] = p1(point[0]) * d1p2(point[1]) * d1p0(point[2]);
          data.phi[ek[ 5][1]].ref_hess[0][0] = d2p1(point[0]) * p3(point[1]) * p0(point[2]);
          data.phi[ek[ 5][1]].ref_hess[1][1] = p1(point[0]) * d2p3(point[1]) * p0(point[2]);
          data.phi[ek[ 5][1]].ref_hess[2][2] = p1(point[0]) * p3(point[1]) * d2p0(point[2]);
          data.phi[ek[ 5][1]].ref_hess[0][1] =
          data.phi[ek[ 5][1]].ref_hess[1][0] = d1p1(point[0]) * d1p3(point[1]) * p0(point[2]);
          data.phi[ek[ 5][1]].ref_hess[0][2] =
          data.phi[ek[ 5][1]].ref_hess[2][0] = d1p1(point[0]) * p3(point[1]) * d1p0(point[2]);
          data.phi[ek[ 5][1]].ref_hess[1][2] =
          data.phi[ek[ 5][1]].ref_hess[2][1] = p1(point[0]) * d1p3(point[1]) * d1p0(point[2]);
          data.phi[ek[ 6][0]].ref_hess[0][0] = d2p0(point[0]) * p2(point[1]) * p1(point[2]);
          data.phi[ek[ 6][0]].ref_hess[1][1] = p0(point[0]) * d2p2(point[1]) * p1(point[2]);
          data.phi[ek[ 6][0]].ref_hess[2][2] = p0(point[0]) * p2(point[1]) * d2p1(point[2]);
          data.phi[ek[ 6][0]].ref_hess[0][1] =
          data.phi[ek[ 6][0]].ref_hess[1][0] = d1p0(point[0]) * d1p2(point[1]) * p1(point[2]);
          data.phi[ek[ 6][0]].ref_hess[0][2] =
          data.phi[ek[ 6][0]].ref_hess[2][0] = d1p0(point[0]) * p2(point[1]) * d1p1(point[2]);
          data.phi[ek[ 6][0]].ref_hess[1][2] =
          data.phi[ek[ 6][0]].ref_hess[2][1] = p0(point[0]) * d1p2(point[1]) * d1p1(point[2]);
          data.phi[ek[ 6][1]].ref_hess[0][0] = d2p0(point[0]) * p3(point[1]) * p1(point[2]);
          data.phi[ek[ 6][1]].ref_hess[1][1] = p0(point[0]) * d2p3(point[1]) * p1(point[2]);
          data.phi[ek[ 6][1]].ref_hess[2][2] = p0(point[0]) * p3(point[1]) * d2p1(point[2]);
          data.phi[ek[ 6][1]].ref_hess[0][1] =
          data.phi[ek[ 6][1]].ref_hess[1][0] = d1p0(point[0]) * d1p3(point[1]) * p1(point[2]);
          data.phi[ek[ 6][1]].ref_hess[0][2] =
          data.phi[ek[ 6][1]].ref_hess[2][0] = d1p0(point[0]) * p3(point[1]) * d1p1(point[2]);
          data.phi[ek[ 6][1]].ref_hess[1][2] =
          data.phi[ek[ 6][1]].ref_hess[2][1] = p0(point[0]) * d1p3(point[1]) * d1p1(point[2]);
          data.phi[ek[ 7][0]].ref_hess[0][0] = d2p1(point[0]) * p2(point[1]) * p1(point[2]);
          data.phi[ek[ 7][0]].ref_hess[1][1] = p1(point[0]) * d2p2(point[1]) * p1(point[2]);
          data.phi[ek[ 7][0]].ref_hess[2][2] = p1(point[0]) * p2(point[1]) * d2p1(point[2]);
          data.phi[ek[ 7][0]].ref_hess[0][1] =
          data.phi[ek[ 7][0]].ref_hess[1][0] = d1p1(point[0]) * d1p2(point[1]) * p1(point[2]);
          data.phi[ek[ 7][0]].ref_hess[0][2] =
          data.phi[ek[ 7][0]].ref_hess[2][0] = d1p1(point[0]) * p2(point[1]) * d1p1(point[2]);
          data.phi[ek[ 7][0]].ref_hess[1][2] =
          data.phi[ek[ 7][0]].ref_hess[2][1] = p1(point[0]) * d1p2(point[1]) * d1p1(point[2]);
          data.phi[ek[ 7][1]].ref_hess[0][0] = d2p1(point[0]) * p3(point[1]) * p1(point[2]);
          data.phi[ek[ 7][1]].ref_hess[1][1] = p1(point[0]) * d2p3(point[1]) * p1(point[2]);
          data.phi[ek[ 7][1]].ref_hess[2][2] = p1(point[0]) * p3(point[1]) * d2p1(point[2]);
          data.phi[ek[ 7][1]].ref_hess[0][1] =
          data.phi[ek[ 7][1]].ref_hess[1][0] = d1p1(point[0]) * d1p3(point[1]) * p1(point[2]);
          data.phi[ek[ 7][1]].ref_hess[0][2] =
          data.phi[ek[ 7][1]].ref_hess[2][0] = d1p1(point[0]) * p3(point[1]) * d1p1(point[2]);
          data.phi[ek[ 7][1]].ref_hess[1][2] =
          data.phi[ek[ 7][1]].ref_hess[2][1] = p1(point[0]) * d1p3(point[1]) * d1p1(point[2]);
          data.phi[ek[ 8][0]].ref_hess[0][0] = d2p0(point[0]) * p0(point[1]) * p2(point[2]);
          data.phi[ek[ 8][0]].ref_hess[1][1] = p0(point[0]) * d2p0(point[1]) * p2(point[2]);
          data.phi[ek[ 8][0]].ref_hess[2][2] = p0(point[0]) * p0(point[1]) * d2p2(point[2]);
          data.phi[ek[ 8][0]].ref_hess[0][1] =
          data.phi[ek[ 8][0]].ref_hess[1][0] = d1p0(point[0]) * d1p0(point[1]) * p2(point[2]);
          data.phi[ek[ 8][0]].ref_hess[0][2] =
          data.phi[ek[ 8][0]].ref_hess[2][0] = d1p0(point[0]) * p0(point[1]) * d1p2(point[2]);
          data.phi[ek[ 8][0]].ref_hess[1][2] =
          data.phi[ek[ 8][0]].ref_hess[2][1] = p0(point[0]) * d1p0(point[1]) * d1p2(point[2]);
          data.phi[ek[ 8][1]].ref_hess[0][0] = d2p0(point[0]) * p0(point[1]) * p3(point[2]);
          data.phi[ek[ 8][1]].ref_hess[1][1] = p0(point[0]) * d2p0(point[1]) * p3(point[2]);
          data.phi[ek[ 8][1]].ref_hess[2][2] = p0(point[0]) * p0(point[1]) * d2p3(point[2]);
          data.phi[ek[ 8][1]].ref_hess[0][1] =
          data.phi[ek[ 8][1]].ref_hess[1][0] = d1p0(point[0]) * d1p0(point[1]) * p3(point[2]);
          data.phi[ek[ 8][1]].ref_hess[0][2] =
          data.phi[ek[ 8][1]].ref_hess[2][0] = d1p0(point[0]) * p0(point[1]) * d1p3(point[2]);
          data.phi[ek[ 8][1]].ref_hess[1][2] =
          data.phi[ek[ 8][1]].ref_hess[2][1] = p0(point[0]) * d1p0(point[1]) * d1p3(point[2]);
          data.phi[ek[ 9][0]].ref_hess[0][0] = d2p1(point[0]) * p0(point[1]) * p2(point[2]);
          data.phi[ek[ 9][0]].ref_hess[1][1] = p1(point[0]) * d2p0(point[1]) * p2(point[2]);
          data.phi[ek[ 9][0]].ref_hess[2][2] = p1(point[0]) * p0(point[1]) * d2p2(point[2]);
          data.phi[ek[ 9][0]].ref_hess[0][1] =
          data.phi[ek[ 9][0]].ref_hess[1][0] = d1p1(point[0]) * d1p0(point[1]) * p2(point[2]);
          data.phi[ek[ 9][0]].ref_hess[0][2] =
          data.phi[ek[ 9][0]].ref_hess[2][0] = d1p1(point[0]) * p0(point[1]) * d1p2(point[2]);
          data.phi[ek[ 9][0]].ref_hess[1][2] =
          data.phi[ek[ 9][0]].ref_hess[2][1] = p1(point[0]) * d1p0(point[1]) * d1p2(point[2]);
          data.phi[ek[ 9][1]].ref_hess[0][0] = d2p1(point[0]) * p0(point[1]) * p3(point[2]);
          data.phi[ek[ 9][1]].ref_hess[1][1] = p1(point[0]) * d2p0(point[1]) * p3(point[2]);
          data.phi[ek[ 9][1]].ref_hess[2][2] = p1(point[0]) * p0(point[1]) * d2p3(point[2]);
          data.phi[ek[ 9][1]].ref_hess[0][1] =
          data.phi[ek[ 9][1]].ref_hess[1][0] = d1p1(point[0]) * d1p0(point[1]) * p3(point[2]);
          data.phi[ek[ 9][1]].ref_hess[0][2] =
          data.phi[ek[ 9][1]].ref_hess[2][0] = d1p1(point[0]) * p0(point[1]) * d1p3(point[2]);
          data.phi[ek[ 9][1]].ref_hess[1][2] =
          data.phi[ek[ 9][1]].ref_hess[2][1] = p1(point[0]) * d1p0(point[1]) * d1p3(point[2]);
          data.phi[ek[10][0]].ref_hess[0][0] = d2p0(point[0]) * p1(point[1]) * p2(point[2]);
          data.phi[ek[10][0]].ref_hess[1][1] = p0(point[0]) * d2p1(point[1]) * p2(point[2]);
          data.phi[ek[10][0]].ref_hess[2][2] = p0(point[0]) * p1(point[1]) * d2p2(point[2]);
          data.phi[ek[10][0]].ref_hess[0][1] =
          data.phi[ek[10][0]].ref_hess[1][0] = d1p0(point[0]) * d1p1(point[1]) * p2(point[2]);
          data.phi[ek[10][0]].ref_hess[0][2] =
          data.phi[ek[10][0]].ref_hess[2][0] = d1p0(point[0]) * p1(point[1]) * d1p2(point[2]);
          data.phi[ek[10][0]].ref_hess[1][2] =
          data.phi[ek[10][0]].ref_hess[2][1] = p0(point[0]) * d1p1(point[1]) * d1p2(point[2]);
          data.phi[ek[10][1]].ref_hess[0][0] = d2p0(point[0]) * p1(point[1]) * p3(point[2]);
          data.phi[ek[10][1]].ref_hess[1][1] = p0(point[0]) * d2p1(point[1]) * p3(point[2]);
          data.phi[ek[10][1]].ref_hess[2][2] = p0(point[0]) * p1(point[1]) * d2p3(point[2]);
          data.phi[ek[10][1]].ref_hess[0][1] =
          data.phi[ek[10][1]].ref_hess[1][0] = d1p0(point[0]) * d1p1(point[1]) * p3(point[2]);
          data.phi[ek[10][1]].ref_hess[0][2] =
          data.phi[ek[10][1]].ref_hess[2][0] = d1p0(point[0]) * p1(point[1]) * d1p3(point[2]);
          data.phi[ek[10][1]].ref_hess[1][2] =
          data.phi[ek[10][1]].ref_hess[2][1] = p0(point[0]) * d1p1(point[1]) * d1p3(point[2]);
          data.phi[ek[11][0]].ref_hess[0][0] = d2p1(point[0]) * p1(point[1]) * p2(point[2]);
          data.phi[ek[11][0]].ref_hess[1][1] = p1(point[0]) * d2p1(point[1]) * p2(point[2]);
          data.phi[ek[11][0]].ref_hess[2][2] = p1(point[0]) * p1(point[1]) * d2p2(point[2]);
          data.phi[ek[11][0]].ref_hess[0][1] =
          data.phi[ek[11][0]].ref_hess[1][0] = d1p1(point[0]) * d1p1(point[1]) * p2(point[2]);
          data.phi[ek[11][0]].ref_hess[0][2] =
          data.phi[ek[11][0]].ref_hess[2][0] = d1p1(point[0]) * p1(point[1]) * d1p2(point[2]);
          data.phi[ek[11][0]].ref_hess[1][2] =
          data.phi[ek[11][0]].ref_hess[2][1] = p1(point[0]) * d1p1(point[1]) * d1p2(point[2]);
          data.phi[ek[11][1]].ref_hess[0][0] = d2p1(point[0]) * p1(point[1]) * p3(point[2]);
          data.phi[ek[11][1]].ref_hess[1][1] = p1(point[0]) * d2p1(point[1]) * p3(point[2]);
          data.phi[ek[11][1]].ref_hess[2][2] = p1(point[0]) * p1(point[1]) * d2p3(point[2]);
          data.phi[ek[11][1]].ref_hess[0][1] =
          data.phi[ek[11][1]].ref_hess[1][0] = d1p1(point[0]) * d1p1(point[1]) * p3(point[2]);
          data.phi[ek[11][1]].ref_hess[0][2] =
          data.phi[ek[11][1]].ref_hess[2][0] = d1p1(point[0]) * p1(point[1]) * d1p3(point[2]);
          data.phi[ek[11][1]].ref_hess[1][2] =
          data.phi[ek[11][1]].ref_hess[2][1] = p1(point[0]) * d1p1(point[1]) * d1p3(point[2]);
          data.phi[qk[0][0]].ref_hess[0][0] = d2p2(point[0]) * p2(point[1]) * p0(point[2]);
          data.phi[qk[0][0]].ref_hess[1][1] = p2(point[0]) * d2p2(point[1]) * p0(point[2]);
          data.phi[qk[0][0]].ref_hess[2][2] = p2(point[0]) * p2(point[1]) * d2p0(point[2]);
          data.phi[qk[0][0]].ref_hess[0][1] =
          data.phi[qk[0][0]].ref_hess[1][0] = d1p2(point[0]) * d1p2(point[1]) * p0(point[2]);
          data.phi[qk[0][0]].ref_hess[0][2] =
          data.phi[qk[0][0]].ref_hess[2][0] = d1p2(point[0]) * p2(point[1]) * d1p0(point[2]);
          data.phi[qk[0][0]].ref_hess[1][2] =
          data.phi[qk[0][0]].ref_hess[2][1] = p2(point[0]) * d1p2(point[1]) * d1p0(point[2]);
          data.phi[qk[0][1]].ref_hess[0][0] = d2p3(point[0]) * p2(point[1]) * p0(point[2]);
          data.phi[qk[0][1]].ref_hess[1][1] = p3(point[0]) * d2p2(point[1]) * p0(point[2]);
          data.phi[qk[0][1]].ref_hess[2][2] = p3(point[0]) * p2(point[1]) * d2p0(point[2]);
          data.phi[qk[0][1]].ref_hess[0][1] =
          data.phi[qk[0][1]].ref_hess[1][0] = d1p3(point[0]) * d1p2(point[1]) * p0(point[2]);
          data.phi[qk[0][1]].ref_hess[0][2] =
          data.phi[qk[0][1]].ref_hess[2][0] = d1p3(point[0]) * p2(point[1]) * d1p0(point[2]);
          data.phi[qk[0][1]].ref_hess[1][2] =
          data.phi[qk[0][1]].ref_hess[2][1] = p3(point[0]) * d1p2(point[1]) * d1p0(point[2]);
          data.phi[qk[0][2]].ref_hess[0][0] = d2p2(point[0]) * p3(point[1]) * p0(point[2]);
          data.phi[qk[0][2]].ref_hess[1][1] = p2(point[0]) * d2p3(point[1]) * p0(point[2]);
          data.phi[qk[0][2]].ref_hess[2][2] = p2(point[0]) * p3(point[1]) * d2p0(point[2]);
          data.phi[qk[0][2]].ref_hess[0][1] =
          data.phi[qk[0][2]].ref_hess[1][0] = d1p2(point[0]) * d1p3(point[1]) * p0(point[2]);
          data.phi[qk[0][2]].ref_hess[0][2] =
          data.phi[qk[0][2]].ref_hess[2][0] = d1p2(point[0]) * p3(point[1]) * d1p0(point[2]);
          data.phi[qk[0][2]].ref_hess[1][2] =
          data.phi[qk[0][2]].ref_hess[2][1] = p2(point[0]) * d1p3(point[1]) * d1p0(point[2]);
          data.phi[qk[0][3]].ref_hess[0][0] = d2p3(point[0]) * p3(point[1]) * p0(point[2]);
          data.phi[qk[0][3]].ref_hess[1][1] = p3(point[0]) * d2p3(point[1]) * p0(point[2]);
          data.phi[qk[0][3]].ref_hess[2][2] = p3(point[0]) * p3(point[1]) * d2p0(point[2]);
          data.phi[qk[0][3]].ref_hess[0][1] =
          data.phi[qk[0][3]].ref_hess[1][0] = d1p3(point[0]) * d1p3(point[1]) * p0(point[2]);
          data.phi[qk[0][3]].ref_hess[0][2] =
          data.phi[qk[0][3]].ref_hess[2][0] = d1p3(point[0]) * p3(point[1]) * d1p0(point[2]);
          data.phi[qk[0][3]].ref_hess[1][2] =
          data.phi[qk[0][3]].ref_hess[2][1] = p3(point[0]) * d1p3(point[1]) * d1p0(point[2]);
          data.phi[qk[1][0]].ref_hess[0][0] = d2p2(point[0]) * p2(point[1]) * p1(point[2]);
          data.phi[qk[1][0]].ref_hess[1][1] = p2(point[0]) * d2p2(point[1]) * p1(point[2]);
          data.phi[qk[1][0]].ref_hess[2][2] = p2(point[0]) * p2(point[1]) * d2p1(point[2]);
          data.phi[qk[1][0]].ref_hess[0][1] =
          data.phi[qk[1][0]].ref_hess[1][0] = d1p2(point[0]) * d1p2(point[1]) * p1(point[2]);
          data.phi[qk[1][0]].ref_hess[0][2] =
          data.phi[qk[1][0]].ref_hess[2][0] = d1p2(point[0]) * p2(point[1]) * d1p1(point[2]);
          data.phi[qk[1][0]].ref_hess[1][2] =
          data.phi[qk[1][0]].ref_hess[2][1] = p2(point[0]) * d1p2(point[1]) * d1p1(point[2]);
          data.phi[qk[1][1]].ref_hess[0][0] = d2p3(point[0]) * p2(point[1]) * p1(point[2]);
          data.phi[qk[1][1]].ref_hess[1][1] = p3(point[0]) * d2p2(point[1]) * p1(point[2]);
          data.phi[qk[1][1]].ref_hess[2][2] = p3(point[0]) * p2(point[1]) * d2p1(point[2]);
          data.phi[qk[1][1]].ref_hess[0][1] =
          data.phi[qk[1][1]].ref_hess[1][0] = d1p3(point[0]) * d1p2(point[1]) * p1(point[2]);
          data.phi[qk[1][1]].ref_hess[0][2] =
          data.phi[qk[1][1]].ref_hess[2][0] = d1p3(point[0]) * p2(point[1]) * d1p1(point[2]);
          data.phi[qk[1][1]].ref_hess[1][2] =
          data.phi[qk[1][1]].ref_hess[2][1] = p3(point[0]) * d1p2(point[1]) * d1p1(point[2]);
          data.phi[qk[1][2]].ref_hess[0][0] = d2p2(point[0]) * p3(point[1]) * p1(point[2]);
          data.phi[qk[1][2]].ref_hess[1][1] = p2(point[0]) * d2p3(point[1]) * p1(point[2]);
          data.phi[qk[1][2]].ref_hess[2][2] = p2(point[0]) * p3(point[1]) * d2p1(point[2]);
          data.phi[qk[1][2]].ref_hess[0][1] =
          data.phi[qk[1][2]].ref_hess[1][0] = d1p2(point[0]) * d1p3(point[1]) * p1(point[2]);
          data.phi[qk[1][2]].ref_hess[0][2] =
          data.phi[qk[1][2]].ref_hess[2][0] = d1p2(point[0]) * p3(point[1]) * d1p1(point[2]);
          data.phi[qk[1][2]].ref_hess[1][2] =
          data.phi[qk[1][2]].ref_hess[2][1] = p2(point[0]) * d1p3(point[1]) * d1p1(point[2]);
          data.phi[qk[1][3]].ref_hess[0][0] = d2p3(point[0]) * p3(point[1]) * p1(point[2]);
          data.phi[qk[1][3]].ref_hess[1][1] = p3(point[0]) * d2p3(point[1]) * p1(point[2]);
          data.phi[qk[1][3]].ref_hess[2][2] = p3(point[0]) * p3(point[1]) * d2p1(point[2]);
          data.phi[qk[1][3]].ref_hess[0][1] =
          data.phi[qk[1][3]].ref_hess[1][0] = d1p3(point[0]) * d1p3(point[1]) * p1(point[2]);
          data.phi[qk[1][3]].ref_hess[0][2] =
          data.phi[qk[1][3]].ref_hess[2][0] = d1p3(point[0]) * p3(point[1]) * d1p1(point[2]);
          data.phi[qk[1][3]].ref_hess[1][2] =
          data.phi[qk[1][3]].ref_hess[2][1] = p3(point[0]) * d1p3(point[1]) * d1p1(point[2]);
          data.phi[qk[2][0]].ref_hess[0][0] = d2p2(point[0]) * p0(point[1]) * p2(point[2]);
          data.phi[qk[2][0]].ref_hess[1][1] = p2(point[0]) * d2p0(point[1]) * p2(point[2]);
          data.phi[qk[2][0]].ref_hess[2][2] = p2(point[0]) * p0(point[1]) * d2p2(point[2]);
          data.phi[qk[2][0]].ref_hess[0][1] =
          data.phi[qk[2][0]].ref_hess[1][0] = d1p2(point[0]) * d1p0(point[1]) * p2(point[2]);
          data.phi[qk[2][0]].ref_hess[0][2] =
          data.phi[qk[2][0]].ref_hess[2][0] = d1p2(point[0]) * p0(point[1]) * d1p2(point[2]);
          data.phi[qk[2][0]].ref_hess[1][2] =
          data.phi[qk[2][0]].ref_hess[2][1] = p2(point[0]) * d1p0(point[1]) * d1p2(point[2]);
          data.phi[qk[2][1]].ref_hess[0][0] = d2p3(point[0]) * p0(point[1]) * p2(point[2]);
          data.phi[qk[2][1]].ref_hess[1][1] = p3(point[0]) * d2p0(point[1]) * p2(point[2]);
          data.phi[qk[2][1]].ref_hess[2][2] = p3(point[0]) * p0(point[1]) * d2p2(point[2]);
          data.phi[qk[2][1]].ref_hess[0][1] =
          data.phi[qk[2][1]].ref_hess[1][0] = d1p3(point[0]) * d1p0(point[1]) * p2(point[2]);
          data.phi[qk[2][1]].ref_hess[0][2] =
          data.phi[qk[2][1]].ref_hess[2][0] = d1p3(point[0]) * p0(point[1]) * d1p2(point[2]);
          data.phi[qk[2][1]].ref_hess[1][2] =
          data.phi[qk[2][1]].ref_hess[2][1] = p3(point[0]) * d1p0(point[1]) * d1p2(point[2]);
          data.phi[qk[2][2]].ref_hess[0][0] = d2p2(point[0]) * p0(point[1]) * p3(point[2]);
          data.phi[qk[2][2]].ref_hess[1][1] = p2(point[0]) * d2p0(point[1]) * p3(point[2]);
          data.phi[qk[2][2]].ref_hess[2][2] = p2(point[0]) * p0(point[1]) * d2p3(point[2]);
          data.phi[qk[2][2]].ref_hess[0][1] =
          data.phi[qk[2][2]].ref_hess[1][0] = d1p2(point[0]) * d1p0(point[1]) * p3(point[2]);
          data.phi[qk[2][2]].ref_hess[0][2] =
          data.phi[qk[2][2]].ref_hess[2][0] = d1p2(point[0]) * p0(point[1]) * d1p3(point[2]);
          data.phi[qk[2][2]].ref_hess[1][2] =
          data.phi[qk[2][2]].ref_hess[2][1] = p2(point[0]) * d1p0(point[1]) * d1p3(point[2]);
          data.phi[qk[2][3]].ref_hess[0][0] = d2p3(point[0]) * p0(point[1]) * p3(point[2]);
          data.phi[qk[2][3]].ref_hess[1][1] = p3(point[0]) * d2p0(point[1]) * p3(point[2]);
          data.phi[qk[2][3]].ref_hess[2][2] = p3(point[0]) * p0(point[1]) * d2p3(point[2]);
          data.phi[qk[2][3]].ref_hess[0][1] =
          data.phi[qk[2][3]].ref_hess[1][0] = d1p3(point[0]) * d1p0(point[1]) * p3(point[2]);
          data.phi[qk[2][3]].ref_hess[0][2] =
          data.phi[qk[2][3]].ref_hess[2][0] = d1p3(point[0]) * p0(point[1]) * d1p3(point[2]);
          data.phi[qk[2][3]].ref_hess[1][2] =
          data.phi[qk[2][3]].ref_hess[2][1] = p3(point[0]) * d1p0(point[1]) * d1p3(point[2]);
          data.phi[qk[3][0]].ref_hess[0][0] = d2p2(point[0]) * p1(point[1]) * p2(point[2]);
          data.phi[qk[3][0]].ref_hess[1][1] = p2(point[0]) * d2p1(point[1]) * p2(point[2]);
          data.phi[qk[3][0]].ref_hess[2][2] = p2(point[0]) * p1(point[1]) * d2p2(point[2]);
          data.phi[qk[3][0]].ref_hess[0][1] =
          data.phi[qk[3][0]].ref_hess[1][0] = d1p2(point[0]) * d1p1(point[1]) * p2(point[2]);
          data.phi[qk[3][0]].ref_hess[0][2] =
          data.phi[qk[3][0]].ref_hess[2][0] = d1p2(point[0]) * p1(point[1]) * d1p2(point[2]);
          data.phi[qk[3][0]].ref_hess[1][2] =
          data.phi[qk[3][0]].ref_hess[2][1] = p2(point[0]) * d1p1(point[1]) * d1p2(point[2]);
          data.phi[qk[3][1]].ref_hess[0][0] = d2p3(point[0]) * p1(point[1]) * p2(point[2]);
          data.phi[qk[3][1]].ref_hess[1][1] = p3(point[0]) * d2p1(point[1]) * p2(point[2]);
          data.phi[qk[3][1]].ref_hess[2][2] = p3(point[0]) * p1(point[1]) * d2p2(point[2]);
          data.phi[qk[3][1]].ref_hess[0][1] =
          data.phi[qk[3][1]].ref_hess[1][0] = d1p3(point[0]) * d1p1(point[1]) * p2(point[2]);
          data.phi[qk[3][1]].ref_hess[0][2] =
          data.phi[qk[3][1]].ref_hess[2][0] = d1p3(point[0]) * p1(point[1]) * d1p2(point[2]);
          data.phi[qk[3][1]].ref_hess[1][2] =
          data.phi[qk[3][1]].ref_hess[2][1] = p3(point[0]) * d1p1(point[1]) * d1p2(point[2]);
          data.phi[qk[3][2]].ref_hess[0][0] = d2p2(point[0]) * p1(point[1]) * p3(point[2]);
          data.phi[qk[3][2]].ref_hess[1][1] = p2(point[0]) * d2p1(point[1]) * p3(point[2]);
          data.phi[qk[3][2]].ref_hess[2][2] = p2(point[0]) * p1(point[1]) * d2p3(point[2]);
          data.phi[qk[3][2]].ref_hess[0][1] =
          data.phi[qk[3][2]].ref_hess[1][0] = d1p2(point[0]) * d1p1(point[1]) * p3(point[2]);
          data.phi[qk[3][2]].ref_hess[0][2] =
          data.phi[qk[3][2]].ref_hess[2][0] = d1p2(point[0]) * p1(point[1]) * d1p3(point[2]);
          data.phi[qk[3][2]].ref_hess[1][2] =
          data.phi[qk[3][2]].ref_hess[2][1] = p2(point[0]) * d1p1(point[1]) * d1p3(point[2]);
          data.phi[qk[3][3]].ref_hess[0][0] = d2p3(point[0]) * p1(point[1]) * p3(point[2]);
          data.phi[qk[3][3]].ref_hess[1][1] = p3(point[0]) * d2p1(point[1]) * p3(point[2]);
          data.phi[qk[3][3]].ref_hess[2][2] = p3(point[0]) * p1(point[1]) * d2p3(point[2]);
          data.phi[qk[3][3]].ref_hess[0][1] =
          data.phi[qk[3][3]].ref_hess[1][0] = d1p3(point[0]) * d1p1(point[1]) * p3(point[2]);
          data.phi[qk[3][3]].ref_hess[0][2] =
          data.phi[qk[3][3]].ref_hess[2][0] = d1p3(point[0]) * p1(point[1]) * d1p3(point[2]);
          data.phi[qk[3][3]].ref_hess[1][2] =
          data.phi[qk[3][3]].ref_hess[2][1] = p3(point[0]) * d1p1(point[1]) * d1p3(point[2]);
          data.phi[qk[4][0]].ref_hess[0][0] = d2p0(point[0]) * p2(point[1]) * p2(point[2]);
          data.phi[qk[4][0]].ref_hess[1][1] = p0(point[0]) * d2p2(point[1]) * p2(point[2]);
          data.phi[qk[4][0]].ref_hess[2][2] = p0(point[0]) * p2(point[1]) * d2p2(point[2]);
          data.phi[qk[4][0]].ref_hess[0][1] =
          data.phi[qk[4][0]].ref_hess[1][0] = d1p0(point[0]) * d1p2(point[1]) * p2(point[2]);
          data.phi[qk[4][0]].ref_hess[0][2] =
          data.phi[qk[4][0]].ref_hess[2][0] = d1p0(point[0]) * p2(point[1]) * d1p2(point[2]);
          data.phi[qk[4][0]].ref_hess[1][2] =
          data.phi[qk[4][0]].ref_hess[2][1] = p0(point[0]) * d1p2(point[1]) * d1p2(point[2]);
          data.phi[qk[4][1]].ref_hess[0][0] = d2p0(point[0]) * p3(point[1]) * p2(point[2]);
          data.phi[qk[4][1]].ref_hess[1][1] = p0(point[0]) * d2p3(point[1]) * p2(point[2]);
          data.phi[qk[4][1]].ref_hess[2][2] = p0(point[0]) * p3(point[1]) * d2p2(point[2]);
          data.phi[qk[4][1]].ref_hess[0][1] =
          data.phi[qk[4][1]].ref_hess[1][0] = d1p0(point[0]) * d1p3(point[1]) * p2(point[2]);
          data.phi[qk[4][1]].ref_hess[0][2] =
          data.phi[qk[4][1]].ref_hess[2][0] = d1p0(point[0]) * p3(point[1]) * d1p2(point[2]);
          data.phi[qk[4][1]].ref_hess[1][2] =
          data.phi[qk[4][1]].ref_hess[2][1] = p0(point[0]) * d1p3(point[1]) * d1p2(point[2]);
          data.phi[qk[4][2]].ref_hess[0][0] = d2p0(point[0]) * p2(point[1]) * p3(point[2]);
          data.phi[qk[4][2]].ref_hess[1][1] = p0(point[0]) * d2p2(point[1]) * p3(point[2]);
          data.phi[qk[4][2]].ref_hess[2][2] = p0(point[0]) * p2(point[1]) * d2p3(point[2]);
          data.phi[qk[4][2]].ref_hess[0][1] =
          data.phi[qk[4][2]].ref_hess[1][0] = d1p0(point[0]) * d1p2(point[1]) * p3(point[2]);
          data.phi[qk[4][2]].ref_hess[0][2] =
          data.phi[qk[4][2]].ref_hess[2][0] = d1p0(point[0]) * p2(point[1]) * d1p3(point[2]);
          data.phi[qk[4][2]].ref_hess[1][2] =
          data.phi[qk[4][2]].ref_hess[2][1] = p0(point[0]) * d1p2(point[1]) * d1p3(point[2]);
          data.phi[qk[4][3]].ref_hess[0][0] = d2p0(point[0]) * p3(point[1]) * p3(point[2]);
          data.phi[qk[4][3]].ref_hess[1][1] = p0(point[0]) * d2p3(point[1]) * p3(point[2]);
          data.phi[qk[4][3]].ref_hess[2][2] = p0(point[0]) * p3(point[1]) * d2p3(point[2]);
          data.phi[qk[4][3]].ref_hess[0][1] =
          data.phi[qk[4][3]].ref_hess[1][0] = d1p0(point[0]) * d1p3(point[1]) * p3(point[2]);
          data.phi[qk[4][3]].ref_hess[0][2] =
          data.phi[qk[4][3]].ref_hess[2][0] = d1p0(point[0]) * p3(point[1]) * d1p3(point[2]);
          data.phi[qk[4][3]].ref_hess[1][2] =
          data.phi[qk[4][3]].ref_hess[2][1] = p0(point[0]) * d1p3(point[1]) * d1p3(point[2]);
          data.phi[qk[5][0]].ref_hess[0][0] = d2p1(point[0]) * p2(point[1]) * p2(point[2]);
          data.phi[qk[5][0]].ref_hess[1][1] = p1(point[0]) * d2p2(point[1]) * p2(point[2]);
          data.phi[qk[5][0]].ref_hess[2][2] = p1(point[0]) * p2(point[1]) * d2p2(point[2]);
          data.phi[qk[5][0]].ref_hess[0][1] =
          data.phi[qk[5][0]].ref_hess[1][0] = d1p1(point[0]) * d1p2(point[1]) * p2(point[2]);
          data.phi[qk[5][0]].ref_hess[0][2] =
          data.phi[qk[5][0]].ref_hess[2][0] = d1p1(point[0]) * p2(point[1]) * d1p2(point[2]);
          data.phi[qk[5][0]].ref_hess[1][2] =
          data.phi[qk[5][0]].ref_hess[2][1] = p1(point[0]) * d1p2(point[1]) * d1p2(point[2]);
          data.phi[qk[5][1]].ref_hess[0][0] = d2p1(point[0]) * p3(point[1]) * p2(point[2]);
          data.phi[qk[5][1]].ref_hess[1][1] = p1(point[0]) * d2p3(point[1]) * p2(point[2]);
          data.phi[qk[5][1]].ref_hess[2][2] = p1(point[0]) * p3(point[1]) * d2p2(point[2]);
          data.phi[qk[5][1]].ref_hess[0][1] =
          data.phi[qk[5][1]].ref_hess[1][0] = d1p1(point[0]) * d1p3(point[1]) * p2(point[2]);
          data.phi[qk[5][1]].ref_hess[0][2] =
          data.phi[qk[5][1]].ref_hess[2][0] = d1p1(point[0]) * p3(point[1]) * d1p2(point[2]);
          data.phi[qk[5][1]].ref_hess[1][2] =
          data.phi[qk[5][1]].ref_hess[2][1] = p1(point[0]) * d1p3(point[1]) * d1p2(point[2]);
          data.phi[qk[5][2]].ref_hess[0][0] = d2p1(point[0]) * p2(point[1]) * p3(point[2]);
          data.phi[qk[5][2]].ref_hess[1][1] = p1(point[0]) * d2p2(point[1]) * p3(point[2]);
          data.phi[qk[5][2]].ref_hess[2][2] = p1(point[0]) * p2(point[1]) * d2p3(point[2]);
          data.phi[qk[5][2]].ref_hess[0][1] =
          data.phi[qk[5][2]].ref_hess[1][0] = d1p1(point[0]) * d1p2(point[1]) * p3(point[2]);
          data.phi[qk[5][2]].ref_hess[0][2] =
          data.phi[qk[5][2]].ref_hess[2][0] = d1p1(point[0]) * p2(point[1]) * d1p3(point[2]);
          data.phi[qk[5][2]].ref_hess[1][2] =
          data.phi[qk[5][2]].ref_hess[2][1] = p1(point[0]) * d1p2(point[1]) * d1p3(point[2]);
          data.phi[qk[5][3]].ref_hess[0][0] = d2p1(point[0]) * p3(point[1]) * p3(point[2]);
          data.phi[qk[5][3]].ref_hess[1][1] = p1(point[0]) * d2p3(point[1]) * p3(point[2]);
          data.phi[qk[5][3]].ref_hess[2][2] = p1(point[0]) * p3(point[1]) * d2p3(point[2]);
          data.phi[qk[5][3]].ref_hess[0][1] =
          data.phi[qk[5][3]].ref_hess[1][0] = d1p1(point[0]) * d1p3(point[1]) * p3(point[2]);
          data.phi[qk[5][3]].ref_hess[0][2] =
          data.phi[qk[5][3]].ref_hess[2][0] = d1p1(point[0]) * p3(point[1]) * d1p3(point[2]);
          data.phi[qk[5][3]].ref_hess[1][2] =
          data.phi[qk[5][3]].ref_hess[2][1] = p1(point[0]) * d1p3(point[1]) * d1p3(point[2]);
          data.phi[56].ref_hess[0][0] = d2p2(point[0]) * p2(point[1]) * p2(point[2]);
          data.phi[56].ref_hess[1][1] = p2(point[0]) * d2p2(point[1]) * p2(point[2]);
          data.phi[56].ref_hess[2][2] = p2(point[0]) * p2(point[1]) * d2p2(point[2]);
          data.phi[56].ref_hess[0][1] =
          data.phi[56].ref_hess[1][0] = d1p2(point[0]) * d1p2(point[1]) * p2(point[2]);
          data.phi[56].ref_hess[0][2] =
          data.phi[56].ref_hess[2][0] = d1p2(point[0]) * p2(point[1]) * d1p2(point[2]);
          data.phi[56].ref_hess[1][2] =
          data.phi[56].ref_hess[2][1] = p2(point[0]) * d1p2(point[1]) * d1p2(point[2]);
          data.phi[57].ref_hess[0][0] = d2p3(point[0]) * p2(point[1]) * p2(point[2]);
          data.phi[57].ref_hess[1][1] = p3(point[0]) * d2p2(point[1]) * p2(point[2]);
          data.phi[57].ref_hess[2][2] = p3(point[0]) * p2(point[1]) * d2p2(point[2]);
          data.phi[57].ref_hess[0][1] =
          data.phi[57].ref_hess[1][0] = d1p3(point[0]) * d1p2(point[1]) * p2(point[2]);
          data.phi[57].ref_hess[0][2] =
          data.phi[57].ref_hess[2][0] = d1p3(point[0]) * p2(point[1]) * d1p2(point[2]);
          data.phi[57].ref_hess[1][2] =
          data.phi[57].ref_hess[2][1] = p3(point[0]) * d1p2(point[1]) * d1p2(point[2]);
          data.phi[58].ref_hess[0][0] = d2p2(point[0]) * p3(point[1]) * p2(point[2]);
          data.phi[58].ref_hess[1][1] = p2(point[0]) * d2p3(point[1]) * p2(point[2]);
          data.phi[58].ref_hess[2][2] = p2(point[0]) * p3(point[1]) * d2p2(point[2]);
          data.phi[58].ref_hess[0][1] =
          data.phi[58].ref_hess[1][0] = d1p2(point[0]) * d1p3(point[1]) * p2(point[2]);
          data.phi[58].ref_hess[0][2] =
          data.phi[58].ref_hess[2][0] = d1p2(point[0]) * p3(point[1]) * d1p2(point[2]);
          data.phi[58].ref_hess[1][2] =
          data.phi[58].ref_hess[2][1] = p2(point[0]) * d1p3(point[1]) * d1p2(point[2]);
          data.phi[59].ref_hess[0][0] = d2p3(point[0]) * p3(point[1]) * p2(point[2]);
          data.phi[59].ref_hess[1][1] = p3(point[0]) * d2p3(point[1]) * p2(point[2]);
          data.phi[59].ref_hess[2][2] = p3(point[0]) * p3(point[1]) * d2p2(point[2]);
          data.phi[59].ref_hess[0][1] =
          data.phi[59].ref_hess[1][0] = d1p3(point[0]) * d1p3(point[1]) * p2(point[2]);
          data.phi[59].ref_hess[0][2] =
          data.phi[59].ref_hess[2][0] = d1p3(point[0]) * p3(point[1]) * d1p2(point[2]);
          data.phi[59].ref_hess[1][2] =
          data.phi[59].ref_hess[2][1] = p3(point[0]) * d1p3(point[1]) * d1p2(point[2]);
          data.phi[60].ref_hess[0][0] = d2p2(point[0]) * p2(point[1]) * p3(point[2]);
          data.phi[60].ref_hess[1][1] = p2(point[0]) * d2p2(point[1]) * p3(point[2]);
          data.phi[60].ref_hess[2][2] = p2(point[0]) * p2(point[1]) * d2p3(point[2]);
          data.phi[60].ref_hess[0][1] =
          data.phi[60].ref_hess[1][0] = d1p2(point[0]) * d1p2(point[1]) * p3(point[2]);
          data.phi[60].ref_hess[0][2] =
          data.phi[60].ref_hess[2][0] = d1p2(point[0]) * p2(point[1]) * d1p3(point[2]);
          data.phi[60].ref_hess[1][2] =
          data.phi[60].ref_hess[2][1] = p2(point[0]) * d1p2(point[1]) * d1p3(point[2]);
          data.phi[61].ref_hess[0][0] = d2p3(point[0]) * p2(point[1]) * p3(point[2]);
          data.phi[61].ref_hess[1][1] = p3(point[0]) * d2p2(point[1]) * p3(point[2]);
          data.phi[61].ref_hess[2][2] = p3(point[0]) * p2(point[1]) * d2p3(point[2]);
          data.phi[61].ref_hess[0][1] =
          data.phi[61].ref_hess[1][0] = d1p3(point[0]) * d1p2(point[1]) * p3(point[2]);
          data.phi[61].ref_hess[0][2] =
          data.phi[61].ref_hess[2][0] = d1p3(point[0]) * p2(point[1]) * d1p3(point[2]);
          data.phi[61].ref_hess[1][2] =
          data.phi[61].ref_hess[2][1] = p3(point[0]) * d1p2(point[1]) * d1p3(point[2]);
          data.phi[62].ref_hess[0][0] = d2p2(point[0]) * p3(point[1]) * p3(point[2]);
          data.phi[62].ref_hess[1][1] = p2(point[0]) * d2p3(point[1]) * p3(point[2]);
          data.phi[62].ref_hess[2][2] = p2(point[0]) * p3(point[1]) * d2p3(point[2]);
          data.phi[62].ref_hess[0][1] =
          data.phi[62].ref_hess[1][0] = d1p2(point[0]) * d1p3(point[1]) * p3(point[2]);
          data.phi[62].ref_hess[0][2] =
          data.phi[62].ref_hess[2][0] = d1p2(point[0]) * p3(point[1]) * d1p3(point[2]);
          data.phi[62].ref_hess[1][2] =
          data.phi[62].ref_hess[2][1] = p2(point[0]) * d1p3(point[1]) * d1p3(point[2]);
          data.phi[63].ref_hess[0][0] = d2p3(point[0]) * p3(point[1]) * p3(point[2]);
          data.phi[63].ref_hess[1][1] = p3(point[0]) * d2p3(point[1]) * p3(point[2]);
          data.phi[63].ref_hess[2][2] = p3(point[0]) * p3(point[1]) * d2p3(point[2]);
          data.phi[63].ref_hess[0][1] =
          data.phi[63].ref_hess[1][0] = d1p3(point[0]) * d1p3(point[1]) * p3(point[2]);
          data.phi[63].ref_hess[0][2] =
          data.phi[63].ref_hess[2][0] = d1p3(point[0]) * p3(point[1]) * d1p3(point[2]);
          data.phi[63].ref_hess[1][2] =
          data.phi[63].ref_hess[2][1] = p3(point[0]) * d1p3(point[1]) * d1p3(point[2]);
        }
