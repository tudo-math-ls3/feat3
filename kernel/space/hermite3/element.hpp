    ...
    namespace Hermite3
    {
      ...
      public:
        ...
        enum
        {
          ...
          num_vert_dofs = DofTraits<ShapeType, 0>::count,
          /// number of dofs per cell
          num_cell_dofs = DofTraits<ShapeType, ShapeType::dimension>::count
        };
        ...
        private:
          ...
          enum
          {
            ...
            num_loc_dofs = Shape::FaceTraits<ShapeType, 0>::count * num_vert_dofs + num_cell_dofs
          };
