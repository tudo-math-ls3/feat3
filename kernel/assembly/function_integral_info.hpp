...
namespace FEAT
{
  namespace Assembly
  {
    ...
    public:
      ...
      /**
       * \brief Formats the local values
       */
      void format()
      {
        max_der = 0;
       ...
       *
       * \param[in] precision
       * The number of digits to print. Defaults to 0, which prints a default number of digits.
       *
       * \param[in] pad_size
     ...
     *
     * \tparam CellVector_ The vector type for the cell data.
     *
