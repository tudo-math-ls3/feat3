...
namespace FEAT
{
  ...
  {
    /**
     * \brief Base class for Burgers Careau assembly jobs
     *
     *  \todo: Fix description regarding Carreau term
     ...
     *
     * \author Maximilian Esser (based on Jonas Duennebacke's and Peter Zajac's Assemblers)
     */
     ...
     * This Job_ class should derive (directly or indirectly) from BurgersCarreauAssemblyJobBase,
    ...
    /**
     * \brief Base class for blocked Burgers Carreau assembly tasks
     *
     * This base class is used by various Burgers assemblers to outsource common code related to
    ...
    /**
     * \brief Burgers Carreau assembly job for block matrix
     *
     * This assembly job implements the blocked (i.e. vector-valued) Burgers operator assembly,
     * which is assembled into a matrix.
     *
     * See the documentation of the BurgersCarreauAssemblyJobBase class template (which is a base class
    ...
    /**
     * \brief Burgers Carreau assembly job for block right-hand-side vector
     *
     * This assembly job implements the blocked (i.e. vector-valued) Burgers operator assembly,
    ...
    /**
     * \brief Base class for scalar Burgers Carreau assembly tasks
     *
     * This base class is used by various Burgers assemblers to outsource common code related to
     * local matrix assembly based on the chosen parameters.
     *
    ...
    /**
     * \brief Burgers Carreau assembly job for scalar matrix
     *
    ...
    /**
     * \brief Burgers Carreau assembly job for scalar right-hand-side vector
     *
     * This assembly job implements the scalar Burgers operator assembly,
     * which is assembled into a right-hand-side vector.
     *
