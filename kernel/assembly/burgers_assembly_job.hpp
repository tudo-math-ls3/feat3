...
namespace FEAT
{
  namespace Assembly
  {
    ...
    /**
     * \brief Burgers assembly job for diagonal of block matrix
     *
     * This assembly job implements the blocked (i.e. vector-valued) Burgers operator assembly,
    ...
    class BurgersBlockedDiagonalAssemblyJob :
    ...
    public:
       ...
       * The name of the cubature rule to be used for assembly.
       */
      explicit BurgersBlockedDiagonalAssemblyJob(Vector_& vector_, const ConvVector_& conv_vector,
        const Space_& space_, const String& cubature_name) :
        BaseClass(conv_vector, space_, cubature_name),
        vector(vector_)
      {
    ...
    public:
      /// the actual assembly task
      class Task :
        public BurgersBlockedAssemblyTaskBase<BurgersBlockedDiagonalAssemblyJob, DataType, block_size>
      {
      public:
        typedef BurgersBlockedAssemblyTaskBase<BurgersBlockedDiagonalAssemblyJob, DataType, block_size> BaseClass;
      ...
      public:
        /// constructor
        explicit Task(const BurgersBlockedDiagonalAssemblyJob& job_) :
          BaseClass(job_),
          vector(job_.vector)
        {
        }
