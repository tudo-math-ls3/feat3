  ...
  namespace Foundation
  {
    ...
    struct MeshControl<dim_2D>
    {
                                   ...
                                   TargetMeshType_& target_mesh)
      {
        ...
        Geometry::IndexTree<edge_type> it(target_mesh.get_num_entities(0));
        ...
        Geometry::IndexCalculator<face_type, face_type::dimension - 1>::compute(it, target_vertex_at_face, target_edge_at_face);
      }
    ...
    struct MeshControl<dim_3D>
    {
                                   ...
                                   TargetMeshType_& target_mesh)
      {
        ...
        Geometry::IndexTree<face_type> it_face(target_mesh.get_num_entities(0));
        Geometry::IndexTree<edge_type> it_edge(target_mesh.get_num_entities(0));
        ...
        Geometry::IndexCalculator<poly_type, poly_type::dimension - 1>::compute(it_face, target_vertex_at_polyhedron, target_face_at_poly);
        Geometry::IndexCalculator<face_type, face_type::dimension - 1>::compute(it_edge, target_vertex_at_face, target_edge_at_face);
        Geometry::IndexCalculator<poly_type, poly_type::dimension - 2>::compute(it_edge, target_vertex_at_polyhedron, target_edge_at_poly);
      }
