  ...
  public TaggedTest<Tag_, IndexType_, Algo_>
{
  public:
    ...
    virtual void run() const
    {
      ...
      TEST_CHECK(MeshUtil::iz_property(m, attrs.at(0), attrs.at(1), attrs.at(2)));

      TEST_CHECK(!MeshUtil::iz_property(m2, attrs.at(0), attrs.at(1), attrs.at(2)));
      MeshUtil::establish_iz_property(m2, attrs.at(0), attrs.at(1), attrs.at(2));
      TEST_CHECK(MeshUtil::iz_property(m2, attrs.at(0), attrs.at(1), attrs.at(2)));
      ...
      Refinement<Mem::Main,
                 Algo::Generic,
                 mrt_standard>::execute(m_fine, &halos, attrs);
      MeshUtil::establish_iz_property(m_fine, attrs.at(0), attrs.at(1), attrs.at(2));
