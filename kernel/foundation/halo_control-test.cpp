  ...
  public TaggedTest<Tag_, IndexType_>
{
  public:
    ...
    void run() const
    {
      ...
      typedef Geometry::ConformalMesh<Shape::Hypercube<1> > confmeshtype_;
      ...
      Foundation::Halo<0, Foundation::pl_vertex, Foundation::Mesh<Foundation::rnt_1D, Foundation::Topology<IndexType_, OT_, IT_> > > h3(m, 1);
  ...
  public TaggedTest<Tag_, IndexType_>
{
  public:
    ...
    void run() const
    {
      ...
      typedef Geometry::ConformalMesh<Shape::Hypercube<3> > confmeshtype_;
      confmeshtype_ geo_m(index_set);
