  ...
  public TaggedTest<Tag_, IndexType_, Algo_>
{
  public:
    ...
    virtual void run() const
    {
      ...
      {
        { 0, 1, 2, 10 },  { 3, 4, 5, 11},  { 0, 2, 8, 12 },  { 0, 1, 8, 13 },  { 1, 3, 10, 4 },  { 10, 4, 9, 6 },  { 4, 6, 11, 7 },  { 1, 3, 13, 5},  { 9, 6, 14, 7 },  { 15, 10, 11, 4 },  { 15, 10, 12, 2 },  { 15, 10, 13, 1 },  { 15, 10, 14, 9 },  { 15, 11, 13, 5 },  { 15, 11, 14, 7 },  { 15, 12, 13, 8 }
      };
...
// => comm_intersection on face level
      ...
      {
        { 0, 1 },  { 0, 2 },  { 3, 4 },  { 3, 5 },  { 6, 7 },  { 0, 8 },  { 1, 3 },  { 9, 6 },  { 4, 6 },  { 1, 10 },  { 9, 10 },  { 2, 10 },  { 4, 10 },  { 4, 11 },  { 5, 11 },  { 7, 11 },  { 2, 12 },  { 8, 12 },  { 1, 13},  { 5, 13 },  { 8, 13 },  { 9, 14 },  { 7, 14 },  { 10, 15 },  { 11, 15 },  { 12, 15 },  { 13, 15 },  { 14, 15 }
      };
      ...
      {
        {0., 0., 0.}, {0.5, 0., 0.}, {0., 0.5, 0.}, {1., 0., 0.}, {1., 0.5, 0.}, {1., 0., 0.5}, {1., 1., 0.}, {1., 1., 0.5}, {0., 0., 0.5}, {0.5, 1., 0.}, {0.5, 0.5, 0.}, {1., 0.5, 0.5}, {0., 0.5, 0.5}, {0.5, 0., 0.5}, {0.5, 1., 0.5}, {0.5, 0.5, 0.5}
      };
