...
template <typename DT_>
void Defect<Archs::GPU, Archs::CUDA>::value(DenseVector<Archs::GPU, DT_> & r, const DenseVector<Archs::GPU, DT_> & rhs, const SparseMatrixCSR<Archs::GPU, DT_> & a, const DenseVector<Archs::GPU, DT_> & b)
{
  if (b.size() != a.columns())
...
template void Defect<Archs::GPU, Archs::CUDA>::value(DenseVector<Archs::GPU, float> &, const DenseVector<Archs::GPU, float> &, const SparseMatrixCSR<Archs::GPU, float> &, const DenseVector<Archs::GPU, float> &);
template void Defect<Archs::GPU, Archs::CUDA>::value(DenseVector<Archs::GPU, double> &, const DenseVector<Archs::GPU, double> &, const SparseMatrixCSR<Archs::GPU, double> &, const DenseVector<Archs::GPU, double> &);
