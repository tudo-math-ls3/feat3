...
namespace FEAT
{
  namespace LAFEM
  {
    ...
    public:
      ...
      {
        return this->template _serialise<DT2_, IT2_>(FileMode::fm_dvb, config);
      }
      ...
      void read_from(FileMode mode, std::istream & file)
      {
        ...
        case FileMode::fm_binary:
        {
          ...
          this->template _deserialise<double, std::uint64_t>(FileMode::fm_dvb, file);
          break;
        }
        default:
      ...
      void write_out(FileMode mode, std::ostream & file) const
      {
        ...
        case FileMode::fm_dvb:
        case FileMode::fm_binary:
          this->template _serialise<double, std::uint64_t>(FileMode::fm_dvb, file);
          break;
        default:
          XABORTM("Filemode not supported!");
        }
