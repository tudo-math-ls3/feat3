...
#endif
#ifdef FEAST_BACKENDS_MKL
DVAxpyVTest<Mem::Main, Algo::MKL, float> mkl_dv_axpy_v_test_float;
DVAxpyVTest<Mem::Main, Algo::MKL, double> mkl_dv_axpy_v_test_double;
#endif
#ifdef FEAST_BACKENDS_CUDA
...
public:
  ...
  virtual void run() const
  {
    for (Index size(1) ; size < 1e3 ; size*=2)
    {
      ...
      ref.template product_matvec<Algo_>(a, x);
      ref.template component_product<Algo_>(ref, c);
      ref.template sum<Algo_>(ref, y);
      copy(ref_local, ref);
      ...
      /// \todo should the be an apply equivalent to vector-axpy?
      /*r.template apply<Algo_>(a, x, y, c);
      copy(result_local, r);
...
DVAxpyMVVTest<Mem::Main, Algo::Generic, float, SparseMatrixCSR<Mem::Main, float> > dv_axpy_mv_v_csr_test_float;
DVAxpyMVVTest<Mem::Main, Algo::Generic, double, SparseMatrixCSR<Mem::Main, double> > dv_axpy_mv_v_csr_test_double;
#ifdef FEAST_GMP
DVAxpyMVVTest<Mem::Main, Algo::Generic, mpf_class, SparseMatrixCSR<Mem::Main, mpf_class> > dv_axpy_mv_v_csr_test_mpf_class;
#endif
#ifdef FEAST_MKL
DVAxpyMVVTest<Mem::Main, Algo::MKL, float, SparseMatrixCSR<Mem::Main, float> > mkl_dv_axpy_mv_v_csr_test_float;
DVAxpyMVVTest<Mem::Main, Algo::MKL, double, SparseMatrixCSR<Mem::Main, double> > mkl_dv_axpy_mv_v_csr_test_double;
#endif
DVAxpyMVVTest<Mem::Main, Algo::Generic, float, SparseMatrixELL<Mem::Main, float> > dv_axpy_mv_v_ell_test_float;
DVAxpyMVVTest<Mem::Main, Algo::Generic, double, SparseMatrixELL<Mem::Main, double> > dv_axpy_mv_v_ell_test_double;
#ifdef FEAST_GMP
DVAxpyMVVTest<Mem::Main, Algo::Generic, mpf_class, SparseMatrixELL<Mem::Main, mpf_class> > dv_axpy_mv_v_ell_test_mpf_class;
#endif
#ifdef FEAST_BACKENDS_CUDA
DVAxpyMVVTest<Mem::CUDA, Algo::CUDA, float, SparseMatrixCSR<Mem::CUDA, float> > cuda_dv_axpy_mv_v_csr_test_float;
DVAxpyMVVTest<Mem::CUDA, Algo::CUDA, double, SparseMatrixCSR<Mem::CUDA, double> > cuda_dv_axpy_mv_v_csr_test_double;
DVAxpyMVVTest<Mem::CUDA, Algo::CUDA, float, SparseMatrixELL<Mem::CUDA, float> > cuda_dv_axpy_mv_v_ell_test_float;
DVAxpyMVVTest<Mem::CUDA, Algo::CUDA, double, SparseMatrixELL<Mem::CUDA, double> > cuda_dv_axpy_mv_v_ell_test_double;
#endif
DVAxpyMVVTest<Mem::Main, Algo::Generic, float, SparseMatrixCOO<Mem::Main, float> > dv_axpy_mv_v_coo_test_float;
DVAxpyMVVTest<Mem::Main, Algo::Generic, double, SparseMatrixCOO<Mem::Main, double> > dv_axpy_mv_v_coo_test_double;
#ifdef FEAST_GMP
DVAxpyMVVTest<Mem::Main, Algo::Generic, mpf_class, SparseMatrixCOO<Mem::Main, mpf_class> > dv_axpy_mv_v_coo_test_mpf_class;
#endif
#ifdef FEAST_MKL
DVAxpyMVVTest<Mem::Main, Algo::MKL, float, SparseMatrixCOO<Mem::Main, float> > mkl_dv_axpy_mv_v_coo_test_float;
DVAxpyMVVTest<Mem::Main, Algo::MKL, double, SparseMatrixCOO<Mem::Main, double> > mkl_dv_axpy_mv_v_coo_test_double;
#endif
