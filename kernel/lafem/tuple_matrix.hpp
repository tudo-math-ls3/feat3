...
namespace FEAT
{
  namespace LAFEM
  {
    ...
    class TupleMatrixRow : public Checkpointable
    {
    private:
    ...
    class TupleMatrixRow<First_> : public Checkpointable
    {
    private:
      template<typename,typename...>
      friend class TupleMatrixRow;
    ...
    public:
      ...
      template <typename Mem2_, typename DT2_ = DataType, typename IT2_ = IndexType>
      using ContainerType = class TupleMatrixRow<typename First_::template ContainerType<Mem2_, DT2_, IT2_> >;
    ...
    class TupleMatrix : public Checkpointable
    {
    private:
      template<typename,typename...>
    ...
    class TupleMatrix<FirstRow_>  : public Checkpointable
    {
    private:
      template<typename,typename...>
      friend class TupleMatrix;
    ...
    public:
      ...
      template <typename Mem2_, typename DT2_ = DataType, typename IT2_ = IndexType>
      using ContainerType = class TupleMatrix<typename FirstRow_::template ContainerType<Mem2_, DT2_, IT2_> >;
