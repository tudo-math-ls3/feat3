...
#ifdef FEAT_EICKT
      extern template Index MaxAbsIndex::value_generic(const float * const, const Index);
      extern template Index MaxAbsIndex::value_generic(const double * const, const Index);
#endif
