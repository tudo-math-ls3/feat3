  ...
  namespace LAFEM
  {
    namespace Arch
    {
      ...
      struct Defect<Mem::Main>
      {
        ...
        static void csrsb(DT_ * r, const DT_ * const rhs, const DT_ * const val, const IT_ * const col_ind, const IT_ * const row_ptr, const DT_ * const x, const Index rows, const Index columns, const Index used_elements)
        {
          csrsb_generic<DT_, IT_, BlockSize_>(r, rhs, val, col_ind, row_ptr, x, rows, columns, used_elements);
        }
        ...
        {
#ifdef FEAT_HAVE_MKL
          dense_mkl(r, rhs, val, x, rows, columns);
#else
...
#if defined(FEAT_HAVE_QUADMATH) && !defined(__CUDACC__)
        static void dense(__float128 * r, const __float128 * const rhs, const __float128 * const val, const __float128 * const x, const Index rows, const Index columns)
        {
          dense_generic(r, rhs, val, x, rows, columns);
        }
#endif
        ...
        template <typename DT_, typename IT_, int BlockSize_>
        static void csrsb_generic(DT_ * r, const DT_ * const rhs, const DT_ * const val, const IT_ * const col_ind, const IT_ * const row_ptr, const DT_ * const x, const Index rows, const Index, const Index);
        ...
        static void dense_mkl(float * r, const float * const rhs, const float * const val, const float * const x, const Index rows, const Index columns);
      ...
      struct Defect<Mem::CUDA>
      {
        ...
        template <typename DT_>
        static void csrb_intern(DT_ * r, const DT_ * const rhs, const DT_ * const val, const unsigned long * const col_ind, const unsigned long * const row_ptr, const DT_ * const x, const Index rows, const Index, const Index, const int blocksize);
