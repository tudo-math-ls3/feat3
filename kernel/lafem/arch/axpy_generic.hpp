...
namespace FEAT
{
  namespace LAFEM
  {
    namespace Arch
    {
      ...
      void Axpy<Mem::Main>::csr_generic(DT_ * r, const DT_ a, const DT_ * const x, const DT_ b, const DT_ * const y, const DT_ * const val,
      ...
      void Axpy<Mem::Main>::csrb_generic(DT_ * r, const DT_ a, const DT_ * const x, const DT_ b, const DT_ * const y, const DT_ * const val,
      ...
      void Axpy<Mem::Main>::csrsb_generic(DT_ * r, const DT_ a, const DT_ * const x, const DT_ b, const DT_ * const y, const DT_ * const val, const IT_ * const col_ind, const IT_ * const row_ptr, const Index rows, const Index, const Index)
      {
      ...
      namespace Intern
      {
        ...
        {
          template <typename DT_>
          FORCE_INLINE void single_entry_axpy(Index k, DT_ * const r, const DT_ * const b, const DT_ a, const DT_ * const y, const DT_ beta)
          {
            r[k] = b[k] * a + y[k] * beta;
          }
          ...
          struct AxpySpecialisation
          {
                          ...
                          const IT_ * const cl, const Index /*C*/, const Index rows)
            {
              ...
              for (Index i(0) ; i < rows/C_ ; ++i)
              {
                Intern::LoopUnroller<0, C_>::step(Intern::AxpyELL::zero_entry, tmp);

                for (Index j(0) ; j < cl[i] ; ++j)
                {
                  Intern::LoopUnroller<0, C_>::step(Intern::AxpyELL::single_matrix_entry, tmp, val + cs[i] + j*C_, x, col_ind + cs[i] + j*C_);
                }

                Intern::LoopUnroller<0, C_>::step(single_entry_axpy, r + i*C_, ctmp, a, ((const DT_ * const)r) + i*C_, b);
              }
      ...
      template <typename DT_, typename IT_>
      void Axpy<Mem::Main>::ell_generic(DT_ * r, const DT_ a, const DT_ * const x, const DT_ b, const DT_ * const y, const DT_ * const val,
                                               ...
                                               const Index C, const Index rows)
      {
        ...
        {
        case 2:
          Intern::AxpyELL::AxpySpecialisation<DT_, IT_, 2>::f(r, a, x, b, val, col_ind, cs, cl, C, rows);
          break;
        case 4:
          Intern::AxpyELL::AxpySpecialisation<DT_, IT_, 4>::f(r, a, x, b, val, col_ind, cs, cl, C, rows);
          break;
        case 8:
          Intern::AxpyELL::AxpySpecialisation<DT_, IT_, 8>::f(r, a, x, b, val, col_ind, cs, cl, C, rows);
          break;
        case 16:
          Intern::AxpyELL::AxpySpecialisation<DT_, IT_,16>::f(r, a, x, b, val, col_ind, cs, cl, C, rows);
          break;
        case 32:
          Intern::AxpyELL::AxpySpecialisation<DT_, IT_,32>::f(r, a, x, b, val, col_ind, cs, cl, C, rows);
          break;
        default:
#ifdef DEBUG
...
#endif
          Intern::AxpyELL::AxpyGeneric<DT_, IT_>::f(r, a, x, b, val, col_ind, cs, cl, C, rows);
        }
      }

      template <typename DT_, typename IT_>
      void Axpy<Mem::Main>::coo_generic(DT_ * r, const DT_ a, const DT_ * const x, const DT_ b, const DT_ * const y, const DT_ * const val,
      ...
      namespace Intern
      {
        namespace AxpyBanded
        {
          ...
          struct Iteration_Left
          {
            ...
            {
              Index start(Math::max(Intern::AxpyBanded::start_offset(j-1, offsets, rows, columns, noo),
                                    Intern::AxpyBanded::end_offset(i-1, offsets, rows, columns, noo) + 1));
              Index end  (Math::min(Intern::AxpyBanded::start_offset(j-2, offsets, rows, columns, noo),
                                    Intern::AxpyBanded::end_offset(i-2, offsets, rows, columns, noo) + 1));

              FEAT_IVDEP
                for (Index l(start); l < end; ++l)
                {
                  DT_ tmp(0);
                  Intern::LoopUnroller<0, i-j>::step(Intern::AxpyBanded::single_matrix_entry, &tmp, val + (j-1) * rows + l,
          ...
          template <typename DT_, typename IT_>
          void axpy_banded_generic(DT_ * r, const DT_ alpha, const DT_ * const x, const DT_ beta,
                                   const DT_ * const val, const IT_ * const offsets,
                                   const Index num_of_offsets, const Index rows, const Index columns)
          {
            ...
            for (Index i(k + 1); i > 0;)
            {
              ...
              for (Index j(num_of_offsets + 1); j > 0;)
              {
                ...
                const Index start(Math::max(Intern::AxpyBanded::start_offset(  i, offsets, rows, columns, num_of_offsets),
                                            Intern::AxpyBanded::end_offset  (  j, offsets, rows, columns, num_of_offsets) + 1));
                const Index stop (Math::min(Intern::AxpyBanded::start_offset(i-1, offsets, rows, columns, num_of_offsets),
                                            Intern::AxpyBanded::end_offset  (j-1, offsets, rows, columns, num_of_offsets) + 1));
      ...
      template <typename DT_, typename IT_>
      void Axpy<Mem::Main>::banded_generic(DT_ * r, const DT_ alpha, const DT_ * const x, const DT_ beta, const DT_ * const y,
                                                  const DT_ * const val, const IT_ * const offsets,
                                                  const Index num_of_offsets, const Index rows, const Index columns)
      {
        ...
        {
        case 3:
          Intern::AxpyBanded::Iteration_Right<DT_, IT_, 3, 4>::f(r, alpha, beta, val, offsets, x, rows, columns);
          break;
        case 5:
          Intern::AxpyBanded::Iteration_Right<DT_, IT_, 5, 6>::f(r, alpha, beta, val, offsets, x, rows, columns);
          break;
        case 9:
          Intern::AxpyBanded::Iteration_Right<DT_, IT_, 9, 10>::f(r, alpha, beta, val, offsets, x, rows, columns);
          break;
        case 25:
          Intern::AxpyBanded::Iteration_Right<DT_, IT_, 25, 26>::f(r, alpha, beta, val, offsets, x, rows, columns);
          break;
        default:
#ifdef DEBUG
          /// \todo print warning in feat log file
...
#endif
          Intern::AxpyBanded::axpy_banded_generic(r, alpha, x, beta, val, offsets, num_of_offsets, rows, columns);
        }
#else
        Intern::AxpyBanded::axpy_banded_generic(r, alpha, x, beta, val, offsets, num_of_offsets, rows, columns);
      ...
      template <typename DT_>
      void Axpy<Mem::Main>::dense_generic(DT_ * r, const DT_ alpha, const DT_ beta, const DT_ * const y, const DT_ * const val, const DT_ * const x, const Index rows, const Index columns)
      {
        if (Math::abs(beta) < Math::eps<DT_>())
        {
          MemoryPool<Mem::Main>::set_memory(r, DT_(0), rows);
