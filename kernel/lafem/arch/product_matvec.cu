...
template <typename DT_>
void ProductMatVec<Mem::CUDA, Algo::CUDA>::csr(DT_ * r, const DT_ * const val, const Index * const col_ind, const Index * const row_ptr, const DT_ * const x, const Index rows)
{
  Index blocksize(128);
  dim3 grid;
  dim3 block;
...
template void ProductMatVec<Mem::CUDA, Algo::CUDA>::csr(float *, const float * const, const Index * const, const Index * const, const float * const, const Index);
template void ProductMatVec<Mem::CUDA, Algo::CUDA>::csr(double *, const double * const, const Index * const, const Index * const, const double * const, const Index);


template <typename DT_>
void ProductMatVec<Mem::CUDA, Algo::CUDA>::ell(DT_ * r, const DT_ * const Ax, const Index * const Aj, const Index * const Arl, const DT_ * const x, const Index stride, const Index rows)
{
  Index blocksize(128);
  dim3 grid;
  dim3 block;
