  ...
  namespace LAFEM
  {
    namespace Arch
    {
      struct UnitFilterBlocked
      {
        ...
        {
          BACKEND_SKELETON_VOID_T2(DT_, IT_, filter_rhs_cuda, filter_rhs_generic, filter_rhs_generic, v, block_size, sv_elements, sv_indices, ue, ign_nans)
        }
        ...
        {
          BACKEND_SKELETON_VOID_T2(DT_, IT_, filter_def_cuda, filter_def_generic, filter_def_generic, v, block_size, sv_elements, sv_indices, ue, ign_nans)
        }
        ...
        {
          BACKEND_SKELETON_VOID_T2(DT_, IT_, filter_unit_mat_cuda, filter_unit_mat_generic, filter_unit_mat_generic, mat, row_ptr, col_idx, block_height, block_width, sv_elements, sv_indices, ue, ign_nans)
        }
        ...
        {
          BACKEND_SKELETON_VOID_T2(DT_, IT_, filter_offdiag_row_mat_cuda, filter_offdiag_row_mat_generic, filter_offdiag_row_mat_generic, mat, row_ptr, block_height, block_width, sv_elements, sv_indices, ue, ign_nans)
        }
        ...
        {
          BACKEND_SKELETON_VOID_T2(DT_, IT_, filter_weak_matrix_rows_cuda, filter_weak_matrix_rows_generic, filter_weak_matrix_rows_generic, mat_a, mat_m, row_ptr, block_height, block_width, sv_elements, sv_indices, ue)
        }
