...
template void Axpy<Mem::Main, Algo::Generic>::banded_q1_d2(float *, const float, const float * const, const float * const, const float * const, const Index, const Index);
template void Axpy<Mem::Main, Algo::Generic>::banded_q1_d2(double *, const double, const double * const, const double * const, const double * const, const Index, const Index);

template void Axpy<Mem::Main, Algo::Generic>::banded_q1_d2(float *, const float * const, const float * const, const float * const, const float * const, const Index, const Index);
template void Axpy<Mem::Main, Algo::Generic>::banded_q1_d2(double *, const double * const, const double * const, const double * const, const double * const, const Index, const Index);
