...
namespace FEAT
{
  namespace LAFEM
  {
    namespace Arch
    {
      ...
      void Defect<Mem::Main>::csrsb_generic(DT_ * r, const DT_ * const rhs, const DT_ * const val, const IT_ * const col_ind, const IT_ * const row_ptr, const DT_ * const x, const Index rows, const Index, const Index)
      {
        ...
        const Tiny::Vector<DT_, BlockSize_> * const brhs(reinterpret_cast<const Tiny::Vector<DT_, BlockSize_> *>(rhs));
