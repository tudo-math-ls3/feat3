...
namespace FEAT
{
  namespace LAFEM
  {
     ...
     *
     * \todo reimplement operations for SparseMatrixBanded
     *
     * \author Peter Zajac
     */
    ...
    public:
      ...
      /// vector mirror type
      typedef LAFEM::VectorMirror<DT_, IT_> VectorMirrorType;
    ...
    public:
      ...
      LAFEM::MatrixMirrorBuffer<DT_, IT_> create_buffer(
        const LAFEM::SparseMatrixBCSR<DT_, IT_, bw_, bh_>& matrix) const
      {
        return LAFEM::MatrixMirrorBuffer<DT_, IT_>(_create_buffer_graph(matrix), Index(bw_*bh_));
      }
      ...
      {
        return LAFEM::MatrixMirrorBuffer<DT_, IT_>(_create_buffer_graph(matrix), Index(1));
      }
       ...
       */
      LAFEM::MatrixMirrorBuffer<DT_, IT_> create_buffer(
        const LAFEM::SparseMatrixBanded<DT_, IT_>& matrix) const
      {
        return LAFEM::MatrixMirrorBuffer<DT_, IT_>(_create_buffer_graph(matrix), Index(1));
      }
       ...
       */
      void gather(
        LAFEM::MatrixMirrorBuffer<DT_, IT_>& buffer,
        const LAFEM::SparseMatrixCSR<DT_, IT_>& matrix) const
      {
      ...
      template<int bw_, int bh_>
      void scatter_axpy(
        LAFEM::SparseMatrixBCSR<DT_, IT_, bw_, bh_>& matrix,
        const LAFEM::MatrixMirrorBuffer<DT_, IT_>& buffer,
        const DT_ alpha = DT_(1)) const
      {
        XASSERT(buffer.entries_per_nonzero() == Index(bw_*bh_));
