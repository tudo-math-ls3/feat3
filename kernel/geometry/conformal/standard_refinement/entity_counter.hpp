#pragma once
#ifndef KERNEL_GEOMETRY_CONF_STD_REF_ENTITY_COUNTER_HPP
#define KERNEL_GEOMETRY_CONF_STD_REF_ENTITY_COUNTER_HPP 1
      ...
      namespace StandardRefinement
      {
        ...
        struct EntityCounter
        {
          ...
          static Index count(const Index num_entities[])
          {
            ...
            return EntityCounter<Shape_, face_dim_, cell_dim_-1>::count(num_entities) +
              StdRefTraits<CellType, face_dim_>::count * num_entities[cell_dim_];
          }
        ...
        struct EntityCounter<Shape_, cell_dim_, cell_dim_>
        {
          ...
          static Index count(const Index num_entities[])
          {
            CONTEXT(name() + "::count()");
            typedef typename Shape::FaceTraits<Shape_, cell_dim_>::ShapeType CellType;
            return StdRefTraits<CellType, cell_dim_>::count * num_entities[cell_dim_];
          }
...
#endif // KERNEL_GEOMETRY_CONF_STD_REF_ENTITY_COUNTER_HPP