#pragma once
#ifndef KERNEL_GEOMETRY_CONF_STD_REF_SUBSET_REFINER_HPP
#define KERNEL_GEOMETRY_CONF_STD_REF_SUBSET_REFINER_HPP 1
        ...
        struct SubSetRefiner
        {
            ...
            const TargetSetType& target_set_in)
          {
            ...
            enum
            {
              ...
              num_childs = StdRefTraits<ShapeType,cell_dim_>::count
            };
...
#endif // KERNEL_GEOMETRY_CONF_STD_REF_SUBSET_REFINER_HPP