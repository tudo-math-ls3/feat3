#pragma once
#ifndef KERNEL_GEOMETRY_CONFORMAL_INDEX_SET_HPP
#define KERNEL_GEOMETRY_CONFORMAL_INDEX_SET_HPP 1
  ...
  namespace Geometry
  {
    ...
    namespace Conformal
    {
      ...
      public:
        ...
        /// \cond internal
        /*
        Index& map(Index i, int j)
        {
          return _indices[i][j];
        }

        const Index& map(Index i, int j) const
        {
          return _indices[i][j];
        }
        */
...
#endif // KERNEL_GEOMETRY_CONFORMAL_INDEX_SET_HPP
