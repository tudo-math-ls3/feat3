#pragma once
#ifndef KERNEL_GEOMETRY_RUMPF_FUNCTIONAL_LVLSET_2D_Q1_D2_HPP
#define KERNEL_GEOMETRY_RUMPF_FUNCTIONAL_LVLSET_2D_Q1_D2_HPP 1
...
namespace FEAST
{
  namespace Geometry
  {
    ...
    class RumpfFunctionalLevelset_D2 < MemoryType_, DataType_, Shape::Hypercube<2> > :
    public RumpfFunctional_D2 < MemoryType_, DataType_, Shape::Hypercube<2> >
    {
      public:
        /// Shape type of the underlying transformation
        typedef Shape::Hypercube<2> ShapeType;
        /// Our base class
        typedef RumpfFunctional_D2<MemoryType_, DataType_, ShapeType> BaseClass;
