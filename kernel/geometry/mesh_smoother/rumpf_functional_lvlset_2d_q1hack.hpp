#pragma once
#ifndef KERNEL_GEOMETRY_RUMPF_FUNCTIONAL_LVLSET_2D_Q1HACK_HPP
#define KERNEL_GEOMETRY_RUMPF_FUNCTIONAL_LVLSET_2D_Q1HACK_HPP 1
...
namespace FEAST
{
  namespace Geometry
  {
    ...
    class RumpfFunctionalLevelsetQ1Hack< MemoryType_, DataType_, Shape::Simplex<2> > :
