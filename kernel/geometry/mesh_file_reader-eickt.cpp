...
namespace FEAT
{
  namespace Geometry
  {
    template class MeshNodeLinker<ConformalMesh<Shape::Simplex<2>, 2, 2, Real>>;
    template class MeshNodeLinker<ConformalMesh<Shape::Simplex<3>, 3, 3, Real>>;
    template class MeshNodeLinker<ConformalMesh<Shape::Hypercube<2>, 2, 2, Real>>;
    template class MeshNodeLinker<ConformalMesh<Shape::Hypercube<3>, 3, 3, Real>>;

    template void MeshFileReader::parse<ConformalMesh<Shape::Simplex<2>, 2, 2, Real>>(
      ...
      PartitionSet*);
    template void MeshFileReader::parse<ConformalMesh<Shape::Simplex<3>, 3, 3, Real>>(
      ...
      PartitionSet*);
    template void MeshFileReader::parse<ConformalMesh<Shape::Hypercube<2>, 2, 2, Real>>(
      ...
      PartitionSet*);
    template void MeshFileReader::parse<ConformalMesh<Shape::Hypercube<3>, 3, 3, Real>>(
