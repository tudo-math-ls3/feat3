  ...
  public:
    ...
    static FaceMap& raw_faces()
    {
      ...
      if(result.empty())
      {
        ...
        result.insert(
          {RefinementTypeByDim<2>(0b0001, false),
           RawFaceTemplate().add_entity(V{0.0, 0.0}, V{1.0, 0.0}, V{0.0, 1.0}, V{1.0, 1.0})});
        result.insert(
          {RefinementTypeByDim<2>(0b0010, false),
           RawFaceTemplate().add_entity(V{0.0, 0.0}, V{1.0, 0.0}, V{0.0, 1.0}, V{1.0, 1.0})});
        result.insert(
          {RefinementTypeByDim<2>(0b0100, false),
           RawFaceTemplate().add_entity(V{0.0, 0.0}, V{1.0, 0.0}, V{0.0, 1.0}, V{1.0, 1.0})});
        result.insert(
          {RefinementTypeByDim<2>(0b1000, false),
           RawFaceTemplate().add_entity(V{0.0, 0.0}, V{1.0, 0.0}, V{0.0, 1.0}, V{1.0, 1.0})});
        ...
        result.insert(
          {RefinementTypeByDim<2>(0b0110, false),
           RawFaceTemplate().add_entity(V{0.0, 0.0}, V{1.0, 0.0}, V{0.0, 1.0}, V{1.0, 1.0})});
        result.insert(
          {RefinementTypeByDim<2>(0b1001, false),
           RawFaceTemplate().add_entity(V{0.0, 0.0}, V{1.0, 0.0}, V{0.0, 1.0}, V{1.0, 1.0})});
