#pragma once
#ifndef KERNEL_MESHOPT_RUMPF_FUNCTIONALS_2D_Q1_HPP
#define KERNEL_MESHOPT_RUMPF_FUNCTIONALS_2D_Q1_HPP 1
...
namespace FEAT
{
  namespace Meshopt
  {
    ...
    Trafo::Standard::Mapping<Geometry::ConformalMesh<Shape::Hypercube<shape_dim_>, shape_dim_, shape_dim_, DataType_>>> :
    public RumpfFunctionalBase<DataType_>
    {
      ...
      public:
        ...
        explicit RumpfFunctional(
          ...
          grad_R(0),
          inv_grad_R(0),
          _cubature_factory("newton-cotes-closed:"+stringify(1<<world_dim)),
          _cubature_rule(Cubature::ctor_factory,_cubature_factory),
          _frobenius_grad_R(0),
          _frobenius_cof_grad_R(0),
          _det_grad_R(0),
          _normalised_ref_cell_vol(1<<world_dim),
        ...
        void eval_fval_grad(DataType& fval, Tx& grad, const TgradR& mat_tensor, const TrafoEvaluator& trafo_eval, const SpaceEvaluator& space_eval, const Tx& DOXY(x), const DataType& DOXY(h))
        {
          ...
          //std::cout << "frobenius_cof_grad_R " << _frobenius_cof_grad_R << std::endl;
...
#endif // KERNEL_MESHOPT_RUMPF_FUNCTIONALS_2D_Q1_HPP
