  ...
  namespace ScaRC
  {
    ...
    struct SolverPatternGeneration<ScaRCBlockSmoother, Algo_>
    {
      ...
      template<typename Tag_,
               typename DataType_,
               template<typename, typename, typename> class VT_,
               template<typename, typename, typename> class VMT_,
    ...
    struct SolverPatternGeneration<Richardson, Algo_>
    {
      ...
      template<typename Tag_,
               ...
               template<typename, typename> class StoreT_,
               typename IT_ = Index>
      static std::shared_ptr<SolverFunctorBase<VT_<Tag_, DataType_, IT_> > > execute(SynchronisedPreconditionedSolverData<DataType_,
                                                                                                                     Tag_,
                                                                                                                     VT_,
                                                                                                                     VMT_,
                                                                                                                     MT_,
