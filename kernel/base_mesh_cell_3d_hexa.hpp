...
// die von Cell<3, space_dim_, world_dim_> erbt, und von der dann wieder um Tet und Hexa erben.
    ...
    public:
           ...
           Cell_2D_* f0, Cell_2D_* f1,Cell_2D_* f2, Cell_2D_* f3, Cell_2D_* f4, Cell_2D_* f5)
      {
        ...
        _faces[4] = f4;
        _faces[5] = f5;
        // assure that the faces are in fact of type Quad<space_dim_, world_dim_>, and not "only"
...
//        _set_child(0, new Hexa(vertex(0), new_vertices[0], new_vertices[4], new_vertices[3],
//                               new_edges[0], new_edges[8], new_edges[11], new_edges[7]));
//        _set_child(1, new Hexa(new_vertices[0], vertex(1), new_vertices[1], new_vertices[4],
//                               new_edges[1], new_edges[2], new_edges[9], new_edges[8]));
//        _set_child(2, new Hexa(new_vertices[4], new_vertices[1], vertex(2), new_vertices[2],
//                               new_edges[9], new_edges[3], new_edges[4], new_edges[10]));
//        _set_child(3, new Hexa(new_vertices[3], new_vertices[4], new_vertices[2], vertex(3),
