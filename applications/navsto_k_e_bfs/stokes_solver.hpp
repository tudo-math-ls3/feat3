...
namespace Turb
{
  ...
  public:
    ...
    virtual bool solve_nonlinear_turbulent(GlobalStokesVector& vec_sol, const GlobalStokesVector& vec_rhs,
    ...
    virtual void assemble_nonlinear_defect_turbulent(GlobalStokesVector& vec_def, const GlobalStokesVector& vec_sol, const GlobalStokesVector& vec_rhs,
      const LocalScalarVectorType& vec_k, const LocalScalarVectorType& vec_e, bool filter_def = true);
    ...
    virtual void assemble_burgers_matrices_turbulent(const GlobalStokesVector& vec_sol,
      const LocalScalarVectorType& vec_k, const LocalScalarVectorType& vec_e);
