...
namespace CCNDSimple
{
  ...
  void DomainControl::add_supported_args(SimpleArgParser& args_)
  {
    //          1         2         3         4         5         6         7         8         9         0
    // 123456789-123456789-123456789-123456789-123456789-123456789-123456789-123456789-123456789-123456789-
    Control::Domain::add_supported_pdc_args(args_);
    args_.support("level", "<level-max> [[<levels-med...>] <level-min>]\n"
  ...
  void DomainControl::create(SimpleArgParser& args)
  {
    ...
    mesh_reader.add_mesh_files(_comm, args.query("mesh")->second);
  ...
  void DomainControl::print_info()
  {
    ...
    _comm.print(this->get_chosen_parti_info());

    // plot our levels
    _comm.print("Desired Levels: " + this->format_desired_levels());
    _comm.print("Chosen  Levels: " + this->format_chosen_levels());
  }
} // namespace CCNDSimple
