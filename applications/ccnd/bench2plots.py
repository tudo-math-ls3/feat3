...
#
# This script analyses a (non-empty) sequence of output logfiles generated by the ccnd-unsteady-dfg95-2d/3d application
...
for fn in sys.argv[3:]:
  ...
  if fn.endswith(".log"):
    ...
    name = fn
  data += [[name,x_t[ib:ie],x_dl[ib:ie],x_ll[ib:ie],x_dv[ib:ie],x_lv[ib:ie],x_pd[ib:ie],
            x_fu[ib:ie],x_fl[ib:ie],x_fo[ib:ie],x_h0[ib:ie],x_h1[ib:ie],x_vo[ib:ie],x_di[ib:ie],x_vt[ib:ie]]]
...
genplot_zoom("%s_lift_l_zoom.py" % prefix, data, 3, "Lift (Line)", 0.14, 0.19, 0.91, 1.0)
genplot_full("%s_drag_v_full.py" % prefix, data, 4, "Drag (Volume)")
genplot_zoom("%s_drag_v_zoom.py" % prefix, data, 4, "Drag (Volume)", 0.13, 0.24, 3.17, 3.24)
...
write_table1(fo, data, 3, "Lift (Line)")
write_table2(fo, data, 4, "Drag (Volume)")
...
write_table2(fo, data, 9, "Out Flux")
write_table1(fo, data,10, "H0-Norm of U")
write_table1(fo, data,11, "H1-Norm of U")
write_table1(fo, data,12, "Vorticity")
write_table1(fo, data,13, "Divergence")
write_table1(fo, data,14, "Time Derivative")
fo.close()
