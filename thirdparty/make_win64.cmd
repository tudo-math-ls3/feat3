...
if exist "./SuperLU_DIST" (
  call ./vc_internal/make_superlu.cmd vc%VSVER% dbg x64
  call ./vc_internal/make_superlu.cmd vc%VSVER% opt x64
) else (
...
echo **************************************************************************
if exist "./Zoltan" (
  call ./vc_internal/make_zoltan.cmd vc%VSVER% dbg x64
  call ./vc_internal/make_zoltan.cmd vc%VSVER% opt x64
) else (
  echo Zoltan not found; skipping...
  echo.
)
