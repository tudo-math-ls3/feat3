...
patch_file(directory, os.path.join("GKlib", "include", "gk_arch.h"), [
...
patch_file(directory, os.path.join("GKlib", "src", "gkregex.c"), [
...
patch_file(directory, os.path.join("GKlib", "src", "io.c"), [
  [18, '', '#include <io.h>'],
