...
#
# USAGE: 2d_quad_rect.py x0 x1 y0 y1 [m-list] [n-list] filename
#
# Options:
...
# The call
#      2d_quad_rect.py 0 4 0 2 [1 4 1] 2 mesh.xml
# will create a mesh discretising the domain [0,4]x[0,2] with 3x2 elements,
# where each element has the same Y-dimension and where the horizontally inner
# elements are 4 times as big in X-dimension as the horizontally outer elements:
#
# +-----+--------------------+-----+
# |     |                    |     |
# |     |                    |     |
