...
namespace MatrixInfo
{
  ...
  int main(int argc, char* argv[])
  {
    ...
    // print matrix name
    std::cout << "\n";
    std::cout << String("Matrix Filename").pad_back(pad_len, '.') << ": " << matrix_name << "\n";
    ...
    std::cout << String("Matrix Content").pad_back(pad_len, '.') << ": " << dec_content_code(mat_content) << "\n";
    std::cout << String("Diagonal Content").pad_back(pad_len, '.') << ": " << dec_content_code(dia_content) << "\n";
    std::cout << String("Lower Content").pad_back(pad_len, '.') << ": " << dec_content_code(low_content) << "\n";
    std::cout << String("Upper Content").pad_back(pad_len, '.') << ": " << dec_content_code(upp_content) << "\n";
