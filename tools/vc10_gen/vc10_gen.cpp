...
// path check file
#define KERNEL_PROJECT_PATH "./kernel/kernel.vc10.vcxproj"
...
public:
  ...
  bool write_solution()
  {
    ...
    // include app project
    ofs << "Project(\"{8BC9CEB8-8B4A-11D0-8D11-00A0C91BC942}\") = \"" << project_name << ".vc10\", \"";
    ofs << project_name << ".vc10.vcxproj\", \"" << project_guid << "\"" << endl;
    ofs << "EndProject" << endl;

    // include kernel project
    ofs << "Project(\"{8BC9CEB8-8B4A-11D0-8D11-00A0C91BC942}\") = \"kernel.vc10\", \"";
    ofs << root_path << "\\kernel\\kernel.vc10.vcxproj\", \"" << kernel_guid << "\"" << endl;
    ofs << "EndProject" << endl;
  ...
  bool write_project()
  {
    ...
    string prj_path(project_path + "\\" + project_name + ".vc10.vcxproj");
    ...
    ofs << "  <Import Project=\"$(FeastRootPath)\\visual_studio\\vc10-common-config.xml\" />" << endl;
    ...
    ofs << "  <ItemGroup>" << endl;
    ofs << "    <ProjectReference Include=\"$(FeastRootPath)\\kernel\\kernel.vc10.vcxproj\">" << endl;
    ...
    ofs << "  <Import Project=\"$(FeastRootPath)\\visual_studio\\vc10-target-app.xml\" />" << endl;
